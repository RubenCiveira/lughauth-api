...
CREATE TABLE _audit_action (id CHAR(36) NOT NULL, occurred_at datetime DEFAULT NOW() NOT NULL, actor_id VARCHAR(255) NOT NULL, actor_type VARCHAR(50) NOT NULL, actor_ip VARCHAR(45) NULL, tenant_id VARCHAR(255) NULL, session_id VARCHAR(255) NULL, client_id VARCHAR(255) NULL, user_agent TEXT NULL, request_method VARCHAR(10) NOT NULL, request_path TEXT NOT NULL, action_type VARCHAR(255) NOT NULL, metadata LONGTEXT NULL, CONSTRAINT PK__AUDIT_ACTION PRIMARY KEY (id));
