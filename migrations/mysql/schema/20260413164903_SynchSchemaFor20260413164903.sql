...
CREATE TABLE access_user_granted_client_scopes (uid VARCHAR(255) NOT NULL, version INT NOT NULL, decision_at timestamp DEFAULT NULL NULL, granted BIT DEFAULT 0 NULL, scope VARCHAR(255) NULL, trusted_client VARCHAR(255) NOT NULL, user VARCHAR(255) NOT NULL, CONSTRAINT PK_ACCESS_USER_GRANTED_CLIENT_SCOPES PRIMARY KEY (uid));
...
CREATE INDEX FL_USER_GRANTED_CLIENT_SCOPES_TRUSTED_CLIENT ON access_user_granted_client_scopes(trusted_client);

-- changeset auto.generated:1825492372-63
CREATE INDEX FL_USER_GRANTED_CLIENT_SCOPES_USER ON access_user_granted_client_scopes(user);
...
ALTER TABLE access_user_granted_client_scopes ADD CONSTRAINT FK_ACCESS_USER_GRANTED_CLIENT_SCOPES_TRUSTED_CLIENT FOREIGN KEY (trusted_client) REFERENCES access_trusted_client (uid) ON UPDATE RESTRICT ON DELETE RESTRICT;

-- changeset auto.generated:1825492372-113
ALTER TABLE access_user_granted_client_scopes ADD CONSTRAINT FK_ACCESS_USER_GRANTED_CLIENT_SCOPES_USER FOREIGN KEY (user) REFERENCES access_user (uid) ON UPDATE RESTRICT ON DELETE RESTRICT;
