...
final class SmtpOutboundConfigLoginVOUnitTest extends TestCase
{
  public function test_asignation_keep_value(): void
  {
    $value = 'one';
    $ref = SmtpOutboundConfigLoginVO::from( $value );
    $this->assertEquals('one', $ref->value());
    $other = SmtpOutboundConfigLoginVO::tryFrom($ref, new ConstraintFailList() );
    $this->assertSame($other, $ref);
    $more = SmtpOutboundConfigLoginVO::from($ref);
    $this->assertSame($more, $ref);
  }
  public function test_asignation_invalid_type(): void
  {
    $errors = new ConstraintFailList();
    $other = SmtpOutboundConfigLoginVO::tryFrom(1, $errors);
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(SmtpOutboundConfigLoginVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = SmtpOutboundConfigLoginVO::from('one');     $same = SmtpOutboundConfigLoginVO::from('one');     $other = SmtpOutboundConfigLoginVO::from('other');
