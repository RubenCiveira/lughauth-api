...
final class SmtpOutboundConfigUidVOUnitTest extends TestCase
{
  public function test_asignation_keep_value(): void
  {
    $value = 'one';
    $ref = SmtpOutboundConfigUidVO::from( $value );
    $this->assertEquals('one', $ref->value());
    $other = SmtpOutboundConfigUidVO::tryFrom($ref, new ConstraintFailList() );
    $this->assertSame($other, $ref);
    $more = SmtpOutboundConfigUidVO::from($ref);
    $this->assertSame($more, $ref);
  }
  public function test_asignation_invalid_type(): void
  {
    $errors = new ConstraintFailList();
    $other = SmtpOutboundConfigUidVO::tryFrom(1, $errors);
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(SmtpOutboundConfigUidVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = SmtpOutboundConfigUidVO::from('one');     $same = SmtpOutboundConfigUidVO::from('one');     $other = SmtpOutboundConfigUidVO::from('other');
