...
final class SmtpOutboundConfigRetryDelayVOUnitTest extends TestCase
{
  public function test_asignation_keep_value(): void
  {
    $value = 1;
    $ref = SmtpOutboundConfigRetryDelayVO::from( $value );
    $this->assertEquals(1, $ref->value());
    $other = SmtpOutboundConfigRetryDelayVO::tryFrom($ref, new ConstraintFailList() );
    $this->assertSame($other, $ref);
    $more = SmtpOutboundConfigRetryDelayVO::from($ref);
    $this->assertSame($more, $ref);
  }
  public function test_asignation_invalid_type(): void
  {
    $errors = new ConstraintFailList();
    $other = SmtpOutboundConfigRetryDelayVO::tryFrom('1', $errors);
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(SmtpOutboundConfigRetryDelayVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = SmtpOutboundConfigRetryDelayVO::from(1);     $same = SmtpOutboundConfigRetryDelayVO::from(1);     $other = SmtpOutboundConfigRetryDelayVO::from(2);
