...
final class SmtpOutboundConfigUseTlsVOUnitTest extends TestCase
{
  public function test_asignation_keep_value(): void
  {
    $value = true;
    $ref = SmtpOutboundConfigUseTlsVO::from( $value );
    $this->assertEquals(true, $ref->value());
    $other = SmtpOutboundConfigUseTlsVO::tryFrom($ref, new ConstraintFailList() );
    $this->assertSame($other, $ref);
    $more = SmtpOutboundConfigUseTlsVO::from($ref);
    $this->assertSame($more, $ref);
  }
  public function test_asignation_invalid_type(): void
  {
    $errors = new ConstraintFailList();
    $other = SmtpOutboundConfigUseTlsVO::tryFrom('1', $errors);
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(SmtpOutboundConfigUseTlsVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = SmtpOutboundConfigUseTlsVO::from(true);     $same = SmtpOutboundConfigUseTlsVO::from(true);     $other = SmtpOutboundConfigUseTlsVO::from(false);
