...
final class MessageSendAtVOUnitTest extends TestCase
{
    ...
    {
        $one = MessageSendAtVO::from((new \DateTimeImmutable('1980-08-20T14:32:45.123Z')));
        $same = MessageSendAtVO::from((new \DateTimeImmutable('1980-08-20T14:32:45.123Z')));
        $other = MessageSendAtVO::from((new \DateTimeImmutable('1981-09-06T14:32:45.123Z')));
