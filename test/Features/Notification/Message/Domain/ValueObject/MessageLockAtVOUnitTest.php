...
final class MessageLockAtVOUnitTest extends TestCase
{
    ...
    {
        $one = MessageLockAtVO::from((new \DateTimeImmutable('1980-08-20T14:32:45.123Z')));
        $same = MessageLockAtVO::from((new \DateTimeImmutable('1980-08-20T14:32:45.123Z')));
        $other = MessageLockAtVO::from((new \DateTimeImmutable('1981-09-06T14:32:45.123Z')));
