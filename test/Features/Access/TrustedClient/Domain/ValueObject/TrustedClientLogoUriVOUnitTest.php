...
final class TrustedClientLogoUriVOUnitTest extends TestCase
{
    public function test_asignation_keep_value(): void
    {
        $value = 'one';
        $ref = TrustedClientLogoUriVO::from($value);
        $this->assertEquals('one', $ref->value());
        $other = TrustedClientLogoUriVO::tryFrom($ref, new ConstraintFailList());
        $this->assertSame($other, $ref);
        $more = TrustedClientLogoUriVO::from($ref);
        $this->assertSame($more, $ref);
    }
    public function test_asignation_invalid_type(): void
    {
        $errors = new ConstraintFailList();
        $other = TrustedClientLogoUriVO::tryFrom(1, $errors);
    ...
    public function test_optimist_asignation_invalid_type(): void
    {
        ...
        $method = new ReflectionMethod(TrustedClientLogoUriVO::class, 'fromUnsafe');
        $method->invoke(null, [11, "bad"]);
    }
    public function test_equals(): void
    {
        $one = TrustedClientLogoUriVO::from('one');
        $same = TrustedClientLogoUriVO::from('one');
        $other = TrustedClientLogoUriVO::from('other');
