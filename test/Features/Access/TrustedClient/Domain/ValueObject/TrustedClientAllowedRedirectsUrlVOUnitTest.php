...
final class TrustedClientAllowedRedirectsUrlVOUnitTest extends TestCase
{
  public function test_asignation_keep_value(): void
  {
    $value = 'one';
    $ref = TrustedClientAllowedRedirectsUrlVO::from( $value );
    $this->assertEquals('one', $ref->value());
    $other = TrustedClientAllowedRedirectsUrlVO::tryFrom($ref, new ConstraintFailList() );
    $this->assertSame($other, $ref);
    $more = TrustedClientAllowedRedirectsUrlVO::from($ref);
    $this->assertSame($more, $ref);
  }
  public function test_asignation_invalid_type(): void
  {
    $errors = new ConstraintFailList();
    $other = TrustedClientAllowedRedirectsUrlVO::tryFrom(1, $errors);
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(TrustedClientAllowedRedirectsUrlVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = TrustedClientAllowedRedirectsUrlVO::from('one');     $same = TrustedClientAllowedRedirectsUrlVO::from('one');     $other = TrustedClientAllowedRedirectsUrlVO::from('other');
