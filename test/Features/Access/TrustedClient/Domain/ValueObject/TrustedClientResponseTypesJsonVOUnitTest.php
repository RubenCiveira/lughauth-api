...
final class TrustedClientResponseTypesJsonVOUnitTest extends TestCase
{
    ...
    public function test_optimist_asignation_invalid_type(): void
    {
        ...
        $method = new ReflectionMethod(TrustedClientResponseTypesJsonVO::class, 'fromUnsafe');
    ...
    {
        $ref = TrustedClientResponseTypesJsonVO::empty();
        $this->assertNull($ref->value());
    }
    public function test_try_from_empty(): void
    {
        $ref = TrustedClientResponseTypesJsonVO::tryFrom(null, new ConstraintFailList());
        $this->assertNull($ref->value());
    }
}
