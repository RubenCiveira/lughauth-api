...
final class TrustedClientSecretOauthVOUnitTest extends TestCase
{
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(TrustedClientSecretOauthVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = TrustedClientSecretOauthVO::from('cyphered://cypher');     $same = TrustedClientSecretOauthVO::from('cyphered://cypher');     $other = TrustedClientSecretOauthVO::from('cyphered://ocyphered');
