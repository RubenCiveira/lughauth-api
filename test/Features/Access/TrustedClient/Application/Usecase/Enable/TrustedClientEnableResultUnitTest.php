...
final class TrustedClientEnableResultUnitTest extends TestCase
{
    public function test(): void
    {
        ...
        $this->assertEquals('one', $value->getResponseTypesJsonOrDefault(TrustedClientResponseTypesJsonVO::from($responseTypesJsonOtherValue))->value());
        $this->assertNotEquals('other', $value->getResponseTypesJsonOrDefault(TrustedClientResponseTypesJsonVO::from($responseTypesJsonOtherValue))->value());
        $value->unsetResponseTypesJson();
        $this->assertEquals('other', $value->getResponseTypesJsonOrDefault(TrustedClientResponseTypesJsonVO::from($responseTypesJsonOtherValue))->value());
        $this->assertNotEquals('one', $value->getResponseTypesJsonOrDefault(TrustedClientResponseTypesJsonVO::from($responseTypesJsonOtherValue))->value());
