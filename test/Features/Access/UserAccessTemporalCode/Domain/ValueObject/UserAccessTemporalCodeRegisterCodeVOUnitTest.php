...
final class UserAccessTemporalCodeRegisterCodeVOUnitTest extends TestCase
{
  public function test_asignation_keep_value(): void
  {
    $value = 'one';
    $ref = UserAccessTemporalCodeRegisterCodeVO::from( $value );
    $this->assertEquals('one', $ref->value());
    $other = UserAccessTemporalCodeRegisterCodeVO::tryFrom($ref, new ConstraintFailList() );
    $this->assertSame($other, $ref);
    $more = UserAccessTemporalCodeRegisterCodeVO::from($ref);
    $this->assertSame($more, $ref);
  }
  public function test_asignation_invalid_type(): void
  {
    $errors = new ConstraintFailList();
    $other = UserAccessTemporalCodeRegisterCodeVO::tryFrom(1, $errors);
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(UserAccessTemporalCodeRegisterCodeVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = UserAccessTemporalCodeRegisterCodeVO::from('one');     $same = UserAccessTemporalCodeRegisterCodeVO::from('one');     $other = UserAccessTemporalCodeRegisterCodeVO::from('other');
