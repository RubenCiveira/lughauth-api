...
final class UserAccessTemporalCodeUserVOUnitTest extends TestCase
{
  ...
  {
     $one = UserAccessTemporalCodeUserVO::from(new UserRef('one'));     $same = UserAccessTemporalCodeUserVO::from(new UserRef('one'));     $other = UserAccessTemporalCodeUserVO::from(new UserRef('other'));
