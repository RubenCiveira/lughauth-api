...
final class UserAccessTemporalCodeTempSecondFactorSeedVOUnitTest extends TestCase
{
  ...
  {
     $one = UserAccessTemporalCodeTempSecondFactorSeedVO::from('cyphered://cypher');     $same = UserAccessTemporalCodeTempSecondFactorSeedVO::from('cyphered://cypher');     $other = UserAccessTemporalCodeTempSecondFactorSeedVO::from('cyphered://ocyphered');
