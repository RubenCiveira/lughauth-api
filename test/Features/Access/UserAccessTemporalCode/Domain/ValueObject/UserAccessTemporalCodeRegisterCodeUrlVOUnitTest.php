...
final class UserAccessTemporalCodeRegisterCodeUrlVOUnitTest extends TestCase
{
  ...
  {
     $one = UserAccessTemporalCodeRegisterCodeUrlVO::from('one');     $same = UserAccessTemporalCodeRegisterCodeUrlVO::from('one');     $other = UserAccessTemporalCodeRegisterCodeUrlVO::from('other');
