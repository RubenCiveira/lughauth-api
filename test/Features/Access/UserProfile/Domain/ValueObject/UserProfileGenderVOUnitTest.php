...
final class UserProfileGenderVOUnitTest extends TestCase
{
    public function test_asignation_keep_value(): void
    {
        $value = 'one';
        $ref = UserProfileGenderVO::from($value);
        $this->assertEquals('one', $ref->value());
        $other = UserProfileGenderVO::tryFrom($ref, new ConstraintFailList());
        $this->assertSame($other, $ref);
        $more = UserProfileGenderVO::from($ref);
        $this->assertSame($more, $ref);
    }
    public function test_asignation_invalid_type(): void
    {
        $errors = new ConstraintFailList();
        $other = UserProfileGenderVO::tryFrom(1, $errors);
    ...
    public function test_optimist_asignation_invalid_type(): void
    {
        ...
        $method = new ReflectionMethod(UserProfileGenderVO::class, 'fromUnsafe');
        $method->invoke(null, [11, "bad"]);
    }
    public function test_equals(): void
    {
        $one = UserProfileGenderVO::from('one');
        $same = UserProfileGenderVO::from('one');
        $other = UserProfileGenderVO::from('other');
    ...
    {
        $ref = UserProfileGenderVO::empty();
        $this->assertNull($ref->value());
    }
    public function test_try_from_empty(): void
    {
        $ref = UserProfileGenderVO::tryFrom(null, new ConstraintFailList());
        $this->assertNull($ref->value());
    }
