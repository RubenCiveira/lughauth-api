...
final class SecurityDomainUidVOUnitTest extends TestCase
{
    public function test_asignation_keep_value(): void
    {
        $value = 'one';
        $ref = SecurityDomainUidVO::from($value);
        $this->assertEquals('one', $ref->value());
        $other = SecurityDomainUidVO::tryFrom($ref, new ConstraintFailList());
        $this->assertSame($other, $ref);
        $more = SecurityDomainUidVO::from($ref);
        $this->assertSame($more, $ref);
    }
    public function test_asignation_invalid_type(): void
    {
        $errors = new ConstraintFailList();
        $other = SecurityDomainUidVO::tryFrom(1, $errors);
