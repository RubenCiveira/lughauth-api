...
final class UserIdentityRolesUidVOUnitTest extends TestCase
{
    public function test_asignation_keep_value(): void
    {
        $value = 'one';
        $ref = UserIdentityRolesUidVO::from($value);
        $this->assertEquals('one', $ref->value());
        $other = UserIdentityRolesUidVO::tryFrom($ref, new ConstraintFailList());
        $this->assertSame($other, $ref);
        $more = UserIdentityRolesUidVO::from($ref);
        $this->assertSame($more, $ref);
    }
    public function test_asignation_invalid_type(): void
    {
        $errors = new ConstraintFailList();
        $other = UserIdentityRolesUidVO::tryFrom(1, $errors);
