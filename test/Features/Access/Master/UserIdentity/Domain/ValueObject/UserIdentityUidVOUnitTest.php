...
final class UserIdentityUidVOUnitTest extends TestCase
{
    public function test_asignation_keep_value(): void
    {
        $value = 'one';
        $ref = UserIdentityUidVO::from($value);
        $this->assertEquals('one', $ref->value());
        $other = UserIdentityUidVO::tryFrom($ref, new ConstraintFailList());
        $this->assertSame($other, $ref);
        $more = UserIdentityUidVO::from($ref);
        $this->assertSame($more, $ref);
    }
    public function test_asignation_invalid_type(): void
    {
        $errors = new ConstraintFailList();
        $other = UserIdentityUidVO::tryFrom(1, $errors);
