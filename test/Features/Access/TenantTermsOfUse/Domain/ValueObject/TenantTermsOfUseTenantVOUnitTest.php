...
final class TenantTermsOfUseTenantVOUnitTest extends TestCase
{
  ...
  {
     $one = TenantTermsOfUseTenantVO::from(new TenantRef('one'));     $same = TenantTermsOfUseTenantVO::from(new TenantRef('one'));     $other = TenantTermsOfUseTenantVO::from(new TenantRef('other'));
