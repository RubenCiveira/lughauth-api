...
final class UserAcceptedTermnsOfUseUserVOUnitTest extends TestCase
{
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(UserAcceptedTermnsOfUseUserVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = UserAcceptedTermnsOfUseUserVO::from(new UserRef('one'));     $same = UserAcceptedTermnsOfUseUserVO::from(new UserRef('one'));     $other = UserAcceptedTermnsOfUseUserVO::from(new UserRef('other'));
