...
final class UserAcceptedTermnsOfUseUserVOUnitTest extends TestCase
{
    ...
    {
        $one = UserAcceptedTermnsOfUseUserVO::from(new UserRef('one'));
        $same = UserAcceptedTermnsOfUseUserVO::from(new UserRef('one'));
        $other = UserAcceptedTermnsOfUseUserVO::from(new UserRef('other'));
