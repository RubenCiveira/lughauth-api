...
final class UserGroupMembershipRelyingPartyVOUnitTest extends TestCase
{
  ...
  {
     $one = UserGroupMembershipRelyingPartyVO::from(new RelyingPartyRef('one'));     $same = UserGroupMembershipRelyingPartyVO::from(new RelyingPartyRef('one'));     $other = UserGroupMembershipRelyingPartyVO::from(new RelyingPartyRef('other'));
