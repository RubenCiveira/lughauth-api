...
final class RoleUidVOUnitTest extends TestCase
{
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(RoleUidVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = RoleUidVO::from('one');     $same = RoleUidVO::from('one');     $other = RoleUidVO::from('other');
