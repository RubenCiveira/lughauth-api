...
final class RoleNameVOUnitTest extends TestCase
{
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(RoleNameVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = RoleNameVO::from('one');     $same = RoleNameVO::from('one');     $other = RoleNameVO::from('other');
