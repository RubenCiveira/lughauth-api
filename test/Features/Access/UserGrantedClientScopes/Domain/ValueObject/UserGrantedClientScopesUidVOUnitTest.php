...
final class UserGrantedClientScopesUidVOUnitTest extends TestCase
{
    public function test_asignation_keep_value(): void
    {
        $value = 'one';
        $ref = UserGrantedClientScopesUidVO::from($value);
        $this->assertEquals('one', $ref->value());
        $other = UserGrantedClientScopesUidVO::tryFrom($ref, new ConstraintFailList());
        $this->assertSame($other, $ref);
        $more = UserGrantedClientScopesUidVO::from($ref);
        $this->assertSame($more, $ref);
    }
    public function test_asignation_invalid_type(): void
    {
        $errors = new ConstraintFailList();
        $other = UserGrantedClientScopesUidVO::tryFrom(1, $errors);
    ...
    public function test_optimist_asignation_invalid_type(): void
    {
        ...
        $method = new ReflectionMethod(UserGrantedClientScopesUidVO::class, 'fromUnsafe');
        $method->invoke(null, [11, "bad"]);
    }
    public function test_equals(): void
    {
        $one = UserGrantedClientScopesUidVO::from('one');
        $same = UserGrantedClientScopesUidVO::from('one');
        $other = UserGrantedClientScopesUidVO::from('other');
