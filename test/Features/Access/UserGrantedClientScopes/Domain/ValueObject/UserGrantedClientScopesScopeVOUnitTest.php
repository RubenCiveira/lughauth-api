...
final class UserGrantedClientScopesScopeVOUnitTest extends TestCase
{
    public function test_asignation_keep_value(): void
    {
        $value = 'one';
        $ref = UserGrantedClientScopesScopeVO::from($value);
        $this->assertEquals('one', $ref->value());
        $other = UserGrantedClientScopesScopeVO::tryFrom($ref, new ConstraintFailList());
        $this->assertSame($other, $ref);
        $more = UserGrantedClientScopesScopeVO::from($ref);
        $this->assertSame($more, $ref);
    }
    public function test_asignation_invalid_type(): void
    {
        $errors = new ConstraintFailList();
        $other = UserGrantedClientScopesScopeVO::tryFrom(1, $errors);
    ...
    public function test_optimist_asignation_invalid_type(): void
    {
        ...
        $method = new ReflectionMethod(UserGrantedClientScopesScopeVO::class, 'fromUnsafe');
        $method->invoke(null, [11, "bad"]);
    }
    public function test_equals(): void
    {
        $one = UserGrantedClientScopesScopeVO::from('one');
        $same = UserGrantedClientScopesScopeVO::from('one');
        $other = UserGrantedClientScopesScopeVO::from('other');
