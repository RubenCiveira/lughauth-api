...
final class TenantConfigWebauthnRpNameVOUnitTest extends TestCase
{
    public function test_asignation_keep_value(): void
    {
        $value = 'one';
        $ref = TenantConfigWebauthnRpNameVO::from($value);
        $this->assertEquals('one', $ref->value());
        $other = TenantConfigWebauthnRpNameVO::tryFrom($ref, new ConstraintFailList());
        $this->assertSame($other, $ref);
        $more = TenantConfigWebauthnRpNameVO::from($ref);
        $this->assertSame($more, $ref);
    }
    public function test_asignation_invalid_type(): void
    {
        $errors = new ConstraintFailList();
        $other = TenantConfigWebauthnRpNameVO::tryFrom(1, $errors);
    ...
    public function test_optimist_asignation_invalid_type(): void
    {
        ...
        $method = new ReflectionMethod(TenantConfigWebauthnRpNameVO::class, 'fromUnsafe');
        $method->invoke(null, [11, "bad"]);
    }
    public function test_equals(): void
    {
        $one = TenantConfigWebauthnRpNameVO::from('one');
        $same = TenantConfigWebauthnRpNameVO::from('one');
        $other = TenantConfigWebauthnRpNameVO::from('other');
