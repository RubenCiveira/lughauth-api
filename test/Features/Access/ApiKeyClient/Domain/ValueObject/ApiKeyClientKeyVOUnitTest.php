...
final class ApiKeyClientKeyVOUnitTest extends TestCase
{
  public function test_asignation_keep_value(): void
  {
    $value = 'one';
    $ref = ApiKeyClientKeyVO::from( $value );
    $this->assertEquals('one', $ref->value());
    $other = ApiKeyClientKeyVO::tryFrom($ref, new ConstraintFailList() );
    $this->assertSame($other, $ref);
    $more = ApiKeyClientKeyVO::from($ref);
    $this->assertSame($more, $ref);
  }
  public function test_asignation_invalid_type(): void
  {
    $errors = new ConstraintFailList();
    $other = ApiKeyClientKeyVO::tryFrom(1, $errors);
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(ApiKeyClientKeyVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = ApiKeyClientKeyVO::from('one');     $same = ApiKeyClientKeyVO::from('one');     $other = ApiKeyClientKeyVO::from('other');
