...
final class ApiKeyClientEnabledVOUnitTest extends TestCase
{
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(ApiKeyClientEnabledVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = ApiKeyClientEnabledVO::from(true);     $same = ApiKeyClientEnabledVO::from(true);     $other = ApiKeyClientEnabledVO::from(false);
