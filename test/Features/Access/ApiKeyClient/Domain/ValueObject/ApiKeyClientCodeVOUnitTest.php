...
final class ApiKeyClientCodeVOUnitTest extends TestCase
{
  public function test_asignation_keep_value(): void
  {
    $value = 'one';
    $ref = ApiKeyClientCodeVO::from( $value );
    $this->assertEquals('one', $ref->value());
    $other = ApiKeyClientCodeVO::tryFrom($ref, new ConstraintFailList() );
    $this->assertSame($other, $ref);
    $more = ApiKeyClientCodeVO::from($ref);
    $this->assertSame($more, $ref);
  }
  public function test_asignation_invalid_type(): void
  {
    $errors = new ConstraintFailList();
    $other = ApiKeyClientCodeVO::tryFrom(1, $errors);
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(ApiKeyClientCodeVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = ApiKeyClientCodeVO::from('one');     $same = ApiKeyClientCodeVO::from('one');     $other = ApiKeyClientCodeVO::from('other');
