...
final class TenantEnabledVOUnitTest extends TestCase
{
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(TenantEnabledVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = TenantEnabledVO::from(true);     $same = TenantEnabledVO::from(true);     $other = TenantEnabledVO::from(false);
