...
final class ClientIdentityUidVOUnitTest extends TestCase
{
    ...
    public function test_optimist_asignation_invalid_type(): void
    {
        ...
        $method = new ReflectionMethod(ClientIdentityUidVO::class, 'fromUnsafe');
        $method->invoke(null, [11, "bad"]);
    }
    public function test_equals(): void
    {
        $one = ClientIdentityUidVO::from('one');
        $same = ClientIdentityUidVO::from('one');
        $other = ClientIdentityUidVO::from('other');
