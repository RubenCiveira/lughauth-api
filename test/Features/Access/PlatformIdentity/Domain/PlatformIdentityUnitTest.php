...
final class PlatformIdentityUnitTest extends TestCase
{
    public function test_init_store_values(): void
    {
        // @Arrange
        $one = new PlatformIdentity(
            uid: 'one',
            user: new UserRef('one'),
            relyingParty: new RelyingPartyRef('one'),
            trustedClient: new TrustedClientRef('one'),
            roles: new PlatformIdentityRolesListRef(new PlatformIdentityRolesItem(
        ...
        $calculated = PlatformIdentity::calculatedFields();
    ...
    public function test_create_store_values(): void
    {
        ...
        // @Act
        $other = PlatformIdentity::create($one->toAttributes());
