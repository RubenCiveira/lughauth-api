...
final class UserSecondFactorSeedVOUnitTest extends TestCase
{
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(UserSecondFactorSeedVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = UserSecondFactorSeedVO::from('cyphered://cypher');     $same = UserSecondFactorSeedVO::from('cyphered://cypher');     $other = UserSecondFactorSeedVO::from('cyphered://ocyphered');
