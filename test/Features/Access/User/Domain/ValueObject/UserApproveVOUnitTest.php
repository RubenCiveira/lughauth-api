...
final class UserApproveVOUnitTest extends TestCase
{
    ...
    {
        $one = UserApproveVO::from(UserApproveOptions::UNVERIFIED);
        $same = UserApproveVO::from(UserApproveOptions::UNVERIFIED);
        $other = UserApproveVO::from(UserApproveOptions::PENDING);
