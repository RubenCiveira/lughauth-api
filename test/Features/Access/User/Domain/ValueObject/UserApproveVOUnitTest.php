...
final class UserApproveVOUnitTest extends TestCase
{
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(UserApproveVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = UserApproveVO::from(UserApproveOptions::UNVERIFIED);     $same = UserApproveVO::from(UserApproveOptions::UNVERIFIED);     $other = UserApproveVO::from(UserApproveOptions::PENDING);
