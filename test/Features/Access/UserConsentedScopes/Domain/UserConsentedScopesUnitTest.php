...
final class UserConsentedScopesUnitTest extends TestCase
{
    public function test_init_store_values(): void
    {
        // @Arrange
        $one = new UserConsentedScopes(
            uid: 'one',
    ...
    public function test_create_store_values(): void
    {
        ...
        // @Act
        $other = UserConsentedScopes::create($one->toAttributes());
