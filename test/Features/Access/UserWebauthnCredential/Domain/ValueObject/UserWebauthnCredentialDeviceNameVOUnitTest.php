...
final class UserWebauthnCredentialDeviceNameVOUnitTest extends TestCase
{
    public function test_asignation_keep_value(): void
    {
        $value = 'one';
        $ref = UserWebauthnCredentialDeviceNameVO::from($value);
        $this->assertEquals('one', $ref->value());
        $other = UserWebauthnCredentialDeviceNameVO::tryFrom($ref, new ConstraintFailList());
        $this->assertSame($other, $ref);
        $more = UserWebauthnCredentialDeviceNameVO::from($ref);
        $this->assertSame($more, $ref);
    }
    public function test_asignation_invalid_type(): void
    {
        $errors = new ConstraintFailList();
        $other = UserWebauthnCredentialDeviceNameVO::tryFrom(1, $errors);
    ...
    public function test_optimist_asignation_invalid_type(): void
    {
        ...
        $method = new ReflectionMethod(UserWebauthnCredentialDeviceNameVO::class, 'fromUnsafe');
        $method->invoke(null, [11, "bad"]);
    }
    public function test_equals(): void
    {
        $one = UserWebauthnCredentialDeviceNameVO::from('one');
        $same = UserWebauthnCredentialDeviceNameVO::from('one');
        $other = UserWebauthnCredentialDeviceNameVO::from('other');
