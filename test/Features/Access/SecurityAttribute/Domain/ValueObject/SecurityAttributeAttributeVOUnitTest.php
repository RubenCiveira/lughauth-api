...
final class SecurityAttributeAttributeVOUnitTest extends TestCase
{
    public function test_asignation_keep_value(): void
    {
        $value = 'one';
        $ref = SecurityAttributeAttributeVO::from($value);
        $this->assertEquals('one', $ref->value());
        $other = SecurityAttributeAttributeVO::tryFrom($ref, new ConstraintFailList());
        $this->assertSame($other, $ref);
        $more = SecurityAttributeAttributeVO::from($ref);
        $this->assertSame($more, $ref);
    }
    public function test_asignation_invalid_type(): void
    {
        $errors = new ConstraintFailList();
        $other = SecurityAttributeAttributeVO::tryFrom(1, $errors);
