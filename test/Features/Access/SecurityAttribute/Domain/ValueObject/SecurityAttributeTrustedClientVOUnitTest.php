...
final class SecurityAttributeTrustedClientVOUnitTest extends TestCase
{
    public function test_asignation_keep_value(): void
    {
        ...
        $ref = SecurityAttributeTrustedClientVO::from($value);
        $this->assertEquals($this->getMockBuilder(TrustedClientRef::class)->setConstructorArgs(['one'])->getMock(), $ref->value());
        $other = SecurityAttributeTrustedClientVO::tryFrom($ref, new ConstraintFailList());
        $this->assertSame($other, $ref);
        $more = SecurityAttributeTrustedClientVO::from($ref);
        $this->assertSame($more, $ref);
    }
    public function test_asignation_invalid_type(): void
    {
        $errors = new ConstraintFailList();
        $other = SecurityAttributeTrustedClientVO::tryFrom('1', $errors);
        $this->assertNull($other);
        $this->assertTrue($errors->hasErrors());
    }
    public function test_empty(): void
    {
        $ref = SecurityAttributeTrustedClientVO::empty();
        $this->assertNull($ref->value());
    }
    public function test_try_from_empty(): void
    {
        $ref = SecurityAttributeTrustedClientVO::tryFrom(null, new ConstraintFailList());
        $this->assertNull($ref->value());
    }
}
