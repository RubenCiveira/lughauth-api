...
final class ConsentPurposeTitleVOUnitTest extends TestCase
{
    public function test_asignation_keep_value(): void
    {
        $value = 'one';
        $ref = ConsentPurposeTitleVO::from($value);
        $this->assertEquals('one', $ref->value());
        $other = ConsentPurposeTitleVO::tryFrom($ref, new ConstraintFailList());
        $this->assertSame($other, $ref);
        $more = ConsentPurposeTitleVO::from($ref);
        $this->assertSame($more, $ref);
    }
    public function test_asignation_invalid_type(): void
    {
        $errors = new ConstraintFailList();
        $other = ConsentPurposeTitleVO::tryFrom(1, $errors);
    ...
    public function test_optimist_asignation_invalid_type(): void
    {
        ...
        $method = new ReflectionMethod(ConsentPurposeTitleVO::class, 'fromUnsafe');
        $method->invoke(null, [11, "bad"]);
    }
    public function test_equals(): void
    {
        $one = ConsentPurposeTitleVO::from('one');
        $same = ConsentPurposeTitleVO::from('one');
        $other = ConsentPurposeTitleVO::from('other');
