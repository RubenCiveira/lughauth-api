...
final class RelyingPartyEnabledVOUnitTest extends TestCase
{
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(RelyingPartyEnabledVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = RelyingPartyEnabledVO::from(true);     $same = RelyingPartyEnabledVO::from(true);     $other = RelyingPartyEnabledVO::from(false);
