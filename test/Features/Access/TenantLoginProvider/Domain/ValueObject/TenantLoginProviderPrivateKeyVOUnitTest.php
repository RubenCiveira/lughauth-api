...
final class TenantLoginProviderPrivateKeyVOUnitTest extends TestCase
{
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(TenantLoginProviderPrivateKeyVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = TenantLoginProviderPrivateKeyVO::from('one');     $same = TenantLoginProviderPrivateKeyVO::from('one');     $other = TenantLoginProviderPrivateKeyVO::from('other');
