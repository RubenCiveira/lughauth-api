...
final class TenantLoginProviderVersionVOUnitTest extends TestCase
{
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(TenantLoginProviderVersionVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = TenantLoginProviderVersionVO::from(1);     $same = TenantLoginProviderVersionVO::from(1);     $other = TenantLoginProviderVersionVO::from(2);
