...
final class UserRoleAssignamentRolesUidVOUnitTest extends TestCase
{
  public function test_asignation_keep_value(): void
  {
    $value = 'one';
    $ref = UserRoleAssignamentRolesUidVO::from( $value );
    $this->assertEquals('one', $ref->value());
    $other = UserRoleAssignamentRolesUidVO::tryFrom($ref, new ConstraintFailList() );
    $this->assertSame($other, $ref);
    $more = UserRoleAssignamentRolesUidVO::from($ref);
    $this->assertSame($more, $ref);
  }
  public function test_asignation_invalid_type(): void
  {
    $errors = new ConstraintFailList();
    $other = UserRoleAssignamentRolesUidVO::tryFrom(1, $errors);
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(UserRoleAssignamentRolesUidVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = UserRoleAssignamentRolesUidVO::from('one');     $same = UserRoleAssignamentRolesUidVO::from('one');     $other = UserRoleAssignamentRolesUidVO::from('other');
