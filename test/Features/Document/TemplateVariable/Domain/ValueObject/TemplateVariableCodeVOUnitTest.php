...
final class TemplateVariableCodeVOUnitTest extends TestCase
{
  public function test_asignation_keep_value(): void
  {
    $value = 'one';
    $ref = TemplateVariableCodeVO::from( $value );
    $this->assertEquals('one', $ref->value());
    $other = TemplateVariableCodeVO::tryFrom($ref, new ConstraintFailList() );
    $this->assertSame($other, $ref);
    $more = TemplateVariableCodeVO::from($ref);
    $this->assertSame($more, $ref);
  }
  public function test_asignation_invalid_type(): void
  {
    $errors = new ConstraintFailList();
    $other = TemplateVariableCodeVO::tryFrom(1, $errors);
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(TemplateVariableCodeVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = TemplateVariableCodeVO::from('one');     $same = TemplateVariableCodeVO::from('one');     $other = TemplateVariableCodeVO::from('other');
