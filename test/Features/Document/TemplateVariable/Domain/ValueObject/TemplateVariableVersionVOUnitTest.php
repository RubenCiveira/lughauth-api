...
final class TemplateVariableVersionVOUnitTest extends TestCase
{
  public function test_asignation_keep_value(): void
  {
    $value = 1;
    $ref = TemplateVariableVersionVO::from( $value );
    $this->assertEquals(1, $ref->value());
    $other = TemplateVariableVersionVO::tryFrom($ref, new ConstraintFailList() );
    $this->assertSame($other, $ref);
    $more = TemplateVariableVersionVO::from($ref);
    $this->assertSame($more, $ref);
  }
  public function test_asignation_invalid_type(): void
  {
    $errors = new ConstraintFailList();
    $other = TemplateVariableVersionVO::tryFrom('1', $errors);
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(TemplateVariableVersionVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = TemplateVariableVersionVO::from(1);     $same = TemplateVariableVersionVO::from(1);     $other = TemplateVariableVersionVO::from(2);
  ...
  {
    $ref = TemplateVariableVersionVO::empty();
    $this->assertNull($ref->value());
  }
  public function test_try_from_empty(): void
  {
    $ref = TemplateVariableVersionVO::tryFrom(null, new ConstraintFailList() );
    $this->assertNull($ref->value());
  }
}
