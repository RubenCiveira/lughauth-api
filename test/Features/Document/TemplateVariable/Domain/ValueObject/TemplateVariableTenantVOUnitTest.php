...
final class TemplateVariableTenantVOUnitTest extends TestCase
{
  ...
  {
     $one = TemplateVariableTenantVO::from(new TenantRef('one'));     $same = TemplateVariableTenantVO::from(new TenantRef('one'));     $other = TemplateVariableTenantVO::from(new TenantRef('other'));
