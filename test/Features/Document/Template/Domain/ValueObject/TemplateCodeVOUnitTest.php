...
final class TemplateCodeVOUnitTest extends TestCase
{
  public function test_asignation_keep_value(): void
  {
    $value = 'one';
    $ref = TemplateCodeVO::from( $value );
    $this->assertEquals('one', $ref->value());
    $other = TemplateCodeVO::tryFrom($ref, new ConstraintFailList() );
    $this->assertSame($other, $ref);
    $more = TemplateCodeVO::from($ref);
    $this->assertSame($more, $ref);
  }
  public function test_asignation_invalid_type(): void
  {
    $errors = new ConstraintFailList();
    $other = TemplateCodeVO::tryFrom(1, $errors);
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(TemplateCodeVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = TemplateCodeVO::from('one');     $same = TemplateCodeVO::from('one');     $other = TemplateCodeVO::from('other');
