...
final class TemplateAssetTypeVOUnitTest extends TestCase
{
  public function test_asignation_keep_value(): void
  {
    $value = 'one';
    $ref = TemplateAssetTypeVO::from( $value );
    $this->assertEquals('one', $ref->value());
    $other = TemplateAssetTypeVO::tryFrom($ref, new ConstraintFailList() );
    $this->assertSame($other, $ref);
    $more = TemplateAssetTypeVO::from($ref);
    $this->assertSame($more, $ref);
  }
  public function test_asignation_invalid_type(): void
  {
    $errors = new ConstraintFailList();
    $other = TemplateAssetTypeVO::tryFrom(1, $errors);
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(TemplateAssetTypeVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = TemplateAssetTypeVO::from('one');     $same = TemplateAssetTypeVO::from('one');     $other = TemplateAssetTypeVO::from('other');
