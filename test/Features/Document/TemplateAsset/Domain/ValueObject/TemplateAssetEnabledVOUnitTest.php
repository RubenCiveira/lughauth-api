...
final class TemplateAssetEnabledVOUnitTest extends TestCase
{
  public function test_asignation_keep_value(): void
  {
    $value = true;
    $ref = TemplateAssetEnabledVO::from( $value );
    $this->assertEquals(true, $ref->value());
    $other = TemplateAssetEnabledVO::tryFrom($ref, new ConstraintFailList() );
    $this->assertSame($other, $ref);
    $more = TemplateAssetEnabledVO::from($ref);
    $this->assertSame($more, $ref);
  }
  public function test_asignation_invalid_type(): void
  {
    $errors = new ConstraintFailList();
    $other = TemplateAssetEnabledVO::tryFrom('1', $errors);
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(TemplateAssetEnabledVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = TemplateAssetEnabledVO::from(true);     $same = TemplateAssetEnabledVO::from(true);     $other = TemplateAssetEnabledVO::from(false);
  ...
  {
    $ref = TemplateAssetEnabledVO::empty();
    $this->assertNull($ref->value());
  }
  public function test_try_from_empty(): void
  {
    $ref = TemplateAssetEnabledVO::tryFrom(null, new ConstraintFailList() );
    $this->assertNull($ref->value());
  }
}
