...
final class ThemeUidVOUnitTest extends TestCase
{
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(ThemeUidVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = ThemeUidVO::from('one');     $same = ThemeUidVO::from('one');     $other = ThemeUidVO::from('other');
