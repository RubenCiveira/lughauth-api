...
final class ThemeCustomCssVOUnitTest extends TestCase
{
  public function test_asignation_keep_value(): void
  {
    $value = 'one';
    $ref = ThemeCustomCssVO::from( $value );
    $this->assertEquals('one', $ref->value());
    $other = ThemeCustomCssVO::tryFrom($ref, new ConstraintFailList() );
    $this->assertSame($other, $ref);
    $more = ThemeCustomCssVO::from($ref);
    $this->assertSame($more, $ref);
  }
  public function test_asignation_invalid_type(): void
  {
    $errors = new ConstraintFailList();
    $other = ThemeCustomCssVO::tryFrom(1, $errors);
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(ThemeCustomCssVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = ThemeCustomCssVO::from('one');     $same = ThemeCustomCssVO::from('one');     $other = ThemeCustomCssVO::from('other');
