...
final class TemplateSnippetUidVOUnitTest extends TestCase
{
  public function test_asignation_keep_value(): void
  {
    $value = 'one';
    $ref = TemplateSnippetUidVO::from( $value );
    $this->assertEquals('one', $ref->value());
    $other = TemplateSnippetUidVO::tryFrom($ref, new ConstraintFailList() );
    $this->assertSame($other, $ref);
    $more = TemplateSnippetUidVO::from($ref);
    $this->assertSame($more, $ref);
  }
  public function test_asignation_invalid_type(): void
  {
    $errors = new ConstraintFailList();
    $other = TemplateSnippetUidVO::tryFrom(1, $errors);
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(TemplateSnippetUidVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = TemplateSnippetUidVO::from('one');     $same = TemplateSnippetUidVO::from('one');     $other = TemplateSnippetUidVO::from('other');
