...
final class TemplateSnippetVersionVOUnitTest extends TestCase
{
  public function test_asignation_keep_value(): void
  {
    $value = 1;
    $ref = TemplateSnippetVersionVO::from( $value );
    $this->assertEquals(1, $ref->value());
    $other = TemplateSnippetVersionVO::tryFrom($ref, new ConstraintFailList() );
    $this->assertSame($other, $ref);
    $more = TemplateSnippetVersionVO::from($ref);
    $this->assertSame($more, $ref);
  }
  public function test_asignation_invalid_type(): void
  {
    $errors = new ConstraintFailList();
    $other = TemplateSnippetVersionVO::tryFrom('1', $errors);
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(TemplateSnippetVersionVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = TemplateSnippetVersionVO::from(1);     $same = TemplateSnippetVersionVO::from(1);     $other = TemplateSnippetVersionVO::from(2);
  ...
  {
    $ref = TemplateSnippetVersionVO::empty();
    $this->assertNull($ref->value());
  }
  public function test_try_from_empty(): void
  {
    $ref = TemplateSnippetVersionVO::tryFrom(null, new ConstraintFailList() );
    $this->assertNull($ref->value());
  }
}
