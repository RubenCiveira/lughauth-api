...
final class TemplateSnippetTenantVOUnitTest extends TestCase
{
  ...
  {
     $one = TemplateSnippetTenantVO::from(new TenantRef('one'));     $same = TemplateSnippetTenantVO::from(new TenantRef('one'));     $other = TemplateSnippetTenantVO::from(new TenantRef('other'));
