...
final class TemplateSnippetContentHtmlVOUnitTest extends TestCase
{
  public function test_asignation_keep_value(): void
  {
    $value = 'one';
    $ref = TemplateSnippetContentHtmlVO::from( $value );
    $this->assertEquals('one', $ref->value());
    $other = TemplateSnippetContentHtmlVO::tryFrom($ref, new ConstraintFailList() );
    $this->assertSame($other, $ref);
    $more = TemplateSnippetContentHtmlVO::from($ref);
    $this->assertSame($more, $ref);
  }
  public function test_asignation_invalid_type(): void
  {
    $errors = new ConstraintFailList();
    $other = TemplateSnippetContentHtmlVO::tryFrom(1, $errors);
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(TemplateSnippetContentHtmlVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = TemplateSnippetContentHtmlVO::from('one');     $same = TemplateSnippetContentHtmlVO::from('one');     $other = TemplateSnippetContentHtmlVO::from('other');
