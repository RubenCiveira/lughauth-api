...
final class TemplateSnippetCodeVOUnitTest extends TestCase
{
  public function test_asignation_keep_value(): void
  {
    $value = 'one';
    $ref = TemplateSnippetCodeVO::from( $value );
    $this->assertEquals('one', $ref->value());
    $other = TemplateSnippetCodeVO::tryFrom($ref, new ConstraintFailList() );
    $this->assertSame($other, $ref);
    $more = TemplateSnippetCodeVO::from($ref);
    $this->assertSame($more, $ref);
  }
  public function test_asignation_invalid_type(): void
  {
    $errors = new ConstraintFailList();
    $other = TemplateSnippetCodeVO::tryFrom(1, $errors);
  ...
  public function test_optimist_asignation_invalid_type(): void
  {
    ...
    $method = new ReflectionMethod(TemplateSnippetCodeVO::class, 'fromUnsafe');
    $method->invoke(null, [11, "bad"]);
  }
  public function test_equals(): void

  {
     $one = TemplateSnippetCodeVO::from('one');     $same = TemplateSnippetCodeVO::from('one');     $other = TemplateSnippetCodeVO::from('other');
