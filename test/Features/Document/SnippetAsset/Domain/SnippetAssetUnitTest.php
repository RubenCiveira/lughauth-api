...
final class SnippetAssetUnitTest extends TestCase
{
    public function test_init_store_values(): void
    {
        // @Arrange
        $one = new SnippetAsset(
            uid: 'one',
        ...
        $calculated = SnippetAsset::calculatedFields();
    ...
    public function test_create_store_values(): void
    {
        ...
        // @Act
        $other = SnippetAsset::create($one->toAttributes());
