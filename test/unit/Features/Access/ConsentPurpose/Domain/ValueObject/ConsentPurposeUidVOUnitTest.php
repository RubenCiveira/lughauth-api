...
final class ConsentPurposeUidVOUnitTest extends TestCase
{
    public function test_asignation_keep_value(): void
    {
        $value = 'one';
        $ref = ConsentPurposeUidVO::from($value);
        $this->assertEquals('one', $ref->value());
        $other = ConsentPurposeUidVO::tryFrom($ref, new ConstraintFailList());
        $this->assertSame($other, $ref);
        $more = ConsentPurposeUidVO::from($ref);
        $this->assertSame($more, $ref);
    }
    public function test_asignation_invalid_type(): void
    {
        $errors = new ConstraintFailList();
        $other = ConsentPurposeUidVO::tryFrom(1, $errors);
    ...
    public function test_optimist_asignation_invalid_type(): void
    {
        ...
        $method = new ReflectionMethod(ConsentPurposeUidVO::class, 'fromUnsafe');
        $method->invoke(null, [11, "bad"]);
    }
    public function test_equals(): void
    {
        $one = ConsentPurposeUidVO::from('one');
        $same = ConsentPurposeUidVO::from('one');
        $other = ConsentPurposeUidVO::from('other');
