...
final class UserProfileUpdatedAtVOUnitTest extends TestCase
{
    public function test_asignation_keep_value(): void
    {
        $value = 'one';
        $ref = UserProfileUpdatedAtVO::from($value);
        $this->assertEquals('one', $ref->value());
        $other = UserProfileUpdatedAtVO::tryFrom($ref, new ConstraintFailList());
        $this->assertSame($other, $ref);
        $more = UserProfileUpdatedAtVO::from($ref);
        $this->assertSame($more, $ref);
    }
    public function test_asignation_invalid_type(): void
    {
        $errors = new ConstraintFailList();
        $other = UserProfileUpdatedAtVO::tryFrom(1, $errors);
    ...
    public function test_optimist_asignation_invalid_type(): void
    {
        ...
        $method = new ReflectionMethod(UserProfileUpdatedAtVO::class, 'fromUnsafe');
        $method->invoke(null, [11, "bad"]);
    }
    public function test_equals(): void
    {
        $one = UserProfileUpdatedAtVO::from('one');
        $same = UserProfileUpdatedAtVO::from('one');
        $other = UserProfileUpdatedAtVO::from('other');
