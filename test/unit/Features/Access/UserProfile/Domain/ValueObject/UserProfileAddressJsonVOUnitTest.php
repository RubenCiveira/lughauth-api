...
final class UserProfileAddressJsonVOUnitTest extends TestCase
{
    public function test_asignation_keep_value(): void
    {
        $value = 'one';
        $ref = UserProfileAddressJsonVO::from($value);
        $this->assertEquals('one', $ref->value());
        $other = UserProfileAddressJsonVO::tryFrom($ref, new ConstraintFailList());
        $this->assertSame($other, $ref);
        $more = UserProfileAddressJsonVO::from($ref);
        $this->assertSame($more, $ref);
    }
    public function test_asignation_invalid_type(): void
    {
        $errors = new ConstraintFailList();
        $other = UserProfileAddressJsonVO::tryFrom(1, $errors);
    ...
    public function test_optimist_asignation_invalid_type(): void
    {
        ...
        $method = new ReflectionMethod(UserProfileAddressJsonVO::class, 'fromUnsafe');
        $method->invoke(null, [11, "bad"]);
    }
    public function test_equals(): void
    {
        $one = UserProfileAddressJsonVO::from('one');
        $same = UserProfileAddressJsonVO::from('one');
        $other = UserProfileAddressJsonVO::from('other');
    ...
    {
        $ref = UserProfileAddressJsonVO::empty();
        $this->assertNull($ref->value());
    }
    public function test_try_from_empty(): void
    {
        $ref = UserProfileAddressJsonVO::tryFrom(null, new ConstraintFailList());
        $this->assertNull($ref->value());
    }
}
