...
final class UserProfilePictureUrlVOUnitTest extends TestCase
{
    public function test_asignation_keep_value(): void
    {
        $value = 'one';
        $ref = UserProfilePictureUrlVO::from($value);
        $this->assertEquals('one', $ref->value());
        $other = UserProfilePictureUrlVO::tryFrom($ref, new ConstraintFailList());
        $this->assertSame($other, $ref);
        $more = UserProfilePictureUrlVO::from($ref);
        $this->assertSame($more, $ref);
    }
    public function test_asignation_invalid_type(): void
    {
        $errors = new ConstraintFailList();
        $other = UserProfilePictureUrlVO::tryFrom(1, $errors);
    ...
    public function test_optimist_asignation_invalid_type(): void
    {
        ...
        $method = new ReflectionMethod(UserProfilePictureUrlVO::class, 'fromUnsafe');
        $method->invoke(null, [11, "bad"]);
    }
    public function test_equals(): void
    {
        $one = UserProfilePictureUrlVO::from('one');
        $same = UserProfilePictureUrlVO::from('one');
        $other = UserProfilePictureUrlVO::from('other');
