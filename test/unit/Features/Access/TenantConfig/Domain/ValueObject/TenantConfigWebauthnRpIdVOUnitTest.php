...
final class TenantConfigWebauthnRpIdVOUnitTest extends TestCase
{
    public function test_asignation_keep_value(): void
    {
        $value = 'one';
        $ref = TenantConfigWebauthnRpIdVO::from($value);
        $this->assertEquals('one', $ref->value());
        $other = TenantConfigWebauthnRpIdVO::tryFrom($ref, new ConstraintFailList());
        $this->assertSame($other, $ref);
        $more = TenantConfigWebauthnRpIdVO::from($ref);
        $this->assertSame($more, $ref);
    }
    public function test_asignation_invalid_type(): void
    {
        $errors = new ConstraintFailList();
        $other = TenantConfigWebauthnRpIdVO::tryFrom(1, $errors);
    ...
    public function test_optimist_asignation_invalid_type(): void
    {
        ...
        $method = new ReflectionMethod(TenantConfigWebauthnRpIdVO::class, 'fromUnsafe');
        $method->invoke(null, [11, "bad"]);
    }
    public function test_equals(): void
    {
        $one = TenantConfigWebauthnRpIdVO::from('one');
        $same = TenantConfigWebauthnRpIdVO::from('one');
        $other = TenantConfigWebauthnRpIdVO::from('other');
