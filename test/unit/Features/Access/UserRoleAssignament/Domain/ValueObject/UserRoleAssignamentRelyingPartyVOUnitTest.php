...
final class UserRoleAssignamentRelyingPartyVOUnitTest extends TestCase
{
    ...
    {
        $one = UserRoleAssignamentRelyingPartyVO::from(new RelyingPartyRef('one'));
        $same = UserRoleAssignamentRelyingPartyVO::from(new RelyingPartyRef('one'));
        $other = UserRoleAssignamentRelyingPartyVO::from(new RelyingPartyRef('other'));
