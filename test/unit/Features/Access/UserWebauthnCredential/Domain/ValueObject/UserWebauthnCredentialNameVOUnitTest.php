...
final class UserWebauthnCredentialNameVOUnitTest extends TestCase
{
    public function test_asignation_keep_value(): void
    {
        $value = 'one';
        $ref = UserWebauthnCredentialNameVO::from($value);
        $this->assertEquals('one', $ref->value());
        $other = UserWebauthnCredentialNameVO::tryFrom($ref, new ConstraintFailList());
        $this->assertSame($other, $ref);
        $more = UserWebauthnCredentialNameVO::from($ref);
        $this->assertSame($more, $ref);
    }
    public function test_asignation_invalid_type(): void
    {
        $errors = new ConstraintFailList();
        $other = UserWebauthnCredentialNameVO::tryFrom(1, $errors);
    ...
    public function test_optimist_asignation_invalid_type(): void
    {
        ...
        $method = new ReflectionMethod(UserWebauthnCredentialNameVO::class, 'fromUnsafe');
        $method->invoke(null, [11, "bad"]);
    }
    public function test_equals(): void
    {
        $one = UserWebauthnCredentialNameVO::from('one');
        $same = UserWebauthnCredentialNameVO::from('one');
        $other = UserWebauthnCredentialNameVO::from('other');
