...
final class UserWebauthnCredentialUidVOUnitTest extends TestCase
{
    public function test_asignation_keep_value(): void
    {
        $value = 'one';
        $ref = UserWebauthnCredentialUidVO::from($value);
        $this->assertEquals('one', $ref->value());
        $other = UserWebauthnCredentialUidVO::tryFrom($ref, new ConstraintFailList());
        $this->assertSame($other, $ref);
        $more = UserWebauthnCredentialUidVO::from($ref);
        $this->assertSame($more, $ref);
    }
    public function test_asignation_invalid_type(): void
    {
        $errors = new ConstraintFailList();
        $other = UserWebauthnCredentialUidVO::tryFrom(1, $errors);
    ...
    public function test_optimist_asignation_invalid_type(): void
    {
        ...
        $method = new ReflectionMethod(UserWebauthnCredentialUidVO::class, 'fromUnsafe');
        $method->invoke(null, [11, "bad"]);
    }
    public function test_equals(): void
    {
        $one = UserWebauthnCredentialUidVO::from('one');
        $same = UserWebauthnCredentialUidVO::from('one');
        $other = UserWebauthnCredentialUidVO::from('other');
