...
final class UserConsentedScopesVersionVOUnitTest extends TestCase
{
    public function test_asignation_keep_value(): void
    {
        $value = 1;
        $ref = UserConsentedScopesVersionVO::from($value);
        $this->assertEquals(1, $ref->value());
        $other = UserConsentedScopesVersionVO::tryFrom($ref, new ConstraintFailList());
        $this->assertSame($other, $ref);
        $more = UserConsentedScopesVersionVO::from($ref);
        $this->assertSame($more, $ref);
    }
    public function test_asignation_invalid_type(): void
    {
        $errors = new ConstraintFailList();
        $other = UserConsentedScopesVersionVO::tryFrom('1', $errors);
    ...
    public function test_optimist_asignation_invalid_type(): void
    {
        ...
        $method = new ReflectionMethod(UserConsentedScopesVersionVO::class, 'fromUnsafe');
        $method->invoke(null, [11, "bad"]);
    }
    public function test_equals(): void
    {
        $one = UserConsentedScopesVersionVO::from(1);
        $same = UserConsentedScopesVersionVO::from(1);
        $other = UserConsentedScopesVersionVO::from(2);
    ...
    {
        $ref = UserConsentedScopesVersionVO::empty();
        $this->assertNull($ref->value());
    }
    public function test_try_from_empty(): void
    {
        $ref = UserConsentedScopesVersionVO::tryFrom(null, new ConstraintFailList());
        $this->assertNull($ref->value());
    }
}
