...
final class TenantLoginProviderSamlIdpSsoUrlVOUnitTest extends TestCase
{
    public function test_asignation_keep_value(): void
    {
        $value = 'one';
        $ref = TenantLoginProviderSamlIdpSsoUrlVO::from($value);
        $this->assertEquals('one', $ref->value());
        $other = TenantLoginProviderSamlIdpSsoUrlVO::tryFrom($ref, new ConstraintFailList());
        $this->assertSame($other, $ref);
        $more = TenantLoginProviderSamlIdpSsoUrlVO::from($ref);
        $this->assertSame($more, $ref);
    }
    public function test_asignation_invalid_type(): void
    {
        $errors = new ConstraintFailList();
        $other = TenantLoginProviderSamlIdpSsoUrlVO::tryFrom(1, $errors);
    ...
    public function test_optimist_asignation_invalid_type(): void
    {
        ...
        $method = new ReflectionMethod(TenantLoginProviderSamlIdpSsoUrlVO::class, 'fromUnsafe');
        $method->invoke(null, [11, "bad"]);
    }
    public function test_equals(): void
    {
        $one = TenantLoginProviderSamlIdpSsoUrlVO::from('one');
        $same = TenantLoginProviderSamlIdpSsoUrlVO::from('one');
        $other = TenantLoginProviderSamlIdpSsoUrlVO::from('other');
