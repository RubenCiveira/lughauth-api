...
final class TenantLoginProviderSamlIdpMetadataUrlVOUnitTest extends TestCase
{
    public function test_asignation_keep_value(): void
    {
        $value = 'one';
        $ref = TenantLoginProviderSamlIdpMetadataUrlVO::from($value);
        $this->assertEquals('one', $ref->value());
        $other = TenantLoginProviderSamlIdpMetadataUrlVO::tryFrom($ref, new ConstraintFailList());
        $this->assertSame($other, $ref);
        $more = TenantLoginProviderSamlIdpMetadataUrlVO::from($ref);
        $this->assertSame($more, $ref);
    }
    public function test_asignation_invalid_type(): void
    {
        $errors = new ConstraintFailList();
        $other = TenantLoginProviderSamlIdpMetadataUrlVO::tryFrom(1, $errors);
    ...
    public function test_optimist_asignation_invalid_type(): void
    {
        ...
        $method = new ReflectionMethod(TenantLoginProviderSamlIdpMetadataUrlVO::class, 'fromUnsafe');
        $method->invoke(null, [11, "bad"]);
    }
    public function test_equals(): void
    {
        $one = TenantLoginProviderSamlIdpMetadataUrlVO::from('one');
        $same = TenantLoginProviderSamlIdpMetadataUrlVO::from('one');
        $other = TenantLoginProviderSamlIdpMetadataUrlVO::from('other');
