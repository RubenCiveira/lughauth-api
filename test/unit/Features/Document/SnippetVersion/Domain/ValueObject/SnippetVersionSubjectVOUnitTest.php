...
final class SnippetVersionSubjectVOUnitTest extends TestCase
{
    public function test_asignation_keep_value(): void
    {
        $value = 'one';
        $ref = SnippetVersionSubjectVO::from($value);
        $this->assertEquals('one', $ref->value());
        $other = SnippetVersionSubjectVO::tryFrom($ref, new ConstraintFailList());
        $this->assertSame($other, $ref);
        $more = SnippetVersionSubjectVO::from($ref);
        $this->assertSame($more, $ref);
    }
    public function test_asignation_invalid_type(): void
    {
        $errors = new ConstraintFailList();
        $other = SnippetVersionSubjectVO::tryFrom(1, $errors);
    ...
    public function test_optimist_asignation_invalid_type(): void
    {
        ...
        $method = new ReflectionMethod(SnippetVersionSubjectVO::class, 'fromUnsafe');
        $method->invoke(null, [11, "bad"]);
    }
    public function test_equals(): void
    {
        $one = SnippetVersionSubjectVO::from('one');
        $same = SnippetVersionSubjectVO::from('one');
        $other = SnippetVersionSubjectVO::from('other');
