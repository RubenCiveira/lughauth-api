...
final class SnippetVersionUnitTest extends TestCase
{
    public function test_init_store_values(): void
    {
        // @Arrange
        $one = new SnippetVersion(
            uid: 'one',
            snippet: new SnippetRef('one'),
            locale: 'one',
            subject: 'one',
            contentHtml: 'one',
            contentText: 'one',
        ...
        $calculated = SnippetVersion::calculatedFields();

        // @Assert
        $this->assertEquals([], $calculated);
        $this->assertEquals($one->uid(), $other->uid());
        $this->assertEquals($one->getSnippet(), $other->getSnippet());
        $this->assertTrue($one->isSnippetChanged());
    ...
    public function test_replace_change_values(): void
    {
        ...
        $other = new SnippetVersion(
            uid: 'other',
            snippet: new SnippetRef('other'),
            locale: 'other',
            subject: 'other',
            contentHtml: 'other',
            contentText: 'other',
        ...
        $this->assertEquals($one->getSnippet(), $other->getSnippet());
        $this->assertTrue($one->isSnippetChanged($base));
        $this->assertEquals($one->getLocale(), $other->getLocale());
    ...
    public function test_json_compare(): void
    {
        ...
        $this->assertEquals('one', $json['snippet']['$ref']);
    ...
    public function test_create_store_values(): void
    {
        ...
        // @Act
        $other = SnippetVersion::create($one->toAttributes());
