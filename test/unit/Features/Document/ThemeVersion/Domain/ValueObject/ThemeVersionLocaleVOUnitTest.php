...
final class ThemeVersionLocaleVOUnitTest extends TestCase
{
    public function test_asignation_keep_value(): void
    {
        $value = 'one';
        $ref = ThemeVersionLocaleVO::from($value);
        $this->assertEquals('one', $ref->value());
        $other = ThemeVersionLocaleVO::tryFrom($ref, new ConstraintFailList());
        $this->assertSame($other, $ref);
        $more = ThemeVersionLocaleVO::from($ref);
        $this->assertSame($more, $ref);
    }
    public function test_asignation_invalid_type(): void
    {
        $errors = new ConstraintFailList();
        $other = ThemeVersionLocaleVO::tryFrom(1, $errors);
    ...
    public function test_optimist_asignation_invalid_type(): void
    {
        ...
        $method = new ReflectionMethod(ThemeVersionLocaleVO::class, 'fromUnsafe');
        $method->invoke(null, [11, "bad"]);
    }
    public function test_equals(): void
    {
        $one = ThemeVersionLocaleVO::from('one');
        $same = ThemeVersionLocaleVO::from('one');
        $other = ThemeVersionLocaleVO::from('other');
