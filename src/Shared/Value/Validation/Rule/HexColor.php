...
/**
 * HexColor class validates that the given value is a valid hexadecimal color code (e.g., #FFFFFF).
 * @api
 */
class HexColor implements Rule
{
    /**
     * Checks whether the given value is a valid hexadecimal color code.
     *
