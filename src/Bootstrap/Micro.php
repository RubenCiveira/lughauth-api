...
use Civi\Lughauth\Bootstrap\Middleware\Metrics\FixedIntervalWindowPolicy;
...
class Micro
{
    ...
    private function build(): void
    {
        ...
        $this->register(new SecurityPlugin());
    ...
    private function ensureBackgroundSupervisor()
    {
        ...
        $supervisor = new Supervisor($this->storeDir(''));// dirname(__DIR__, 3));
