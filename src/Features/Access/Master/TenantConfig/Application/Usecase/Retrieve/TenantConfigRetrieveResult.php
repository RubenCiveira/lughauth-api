...
namespace Civi\Lughauth\Features\Access\Master\TenantConfig\Application\Usecase\Retrieve;
...
class TenantConfigRetrieveResult
{
    ...
    public function withDefaults(): TenantConfigRetrieveResult
    {
        $this->withDefaultUid();
