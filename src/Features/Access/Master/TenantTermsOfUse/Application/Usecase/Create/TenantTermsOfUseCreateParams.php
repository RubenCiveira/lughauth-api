...
namespace Civi\Lughauth\Features\Access\Master\TenantTermsOfUse\Application\Usecase\Create;
...
class TenantTermsOfUseCreateParams
{
    ...
    public function withDefaults(): TenantTermsOfUseCreateParams
    {
        $this->withDefaultUid();
