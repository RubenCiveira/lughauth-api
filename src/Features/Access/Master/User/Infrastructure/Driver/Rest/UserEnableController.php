...
use Civi\Lughauth\Features\Access\Master\User\Infrastructure\Driver\Batch\UserTaskEnable;
...
class UserEnableController
{
    ...
    #[OA\Patch(
        path: "/api/access/users/{uid}/enable",
        tags: ["User"],
    ...
    private function mapUser(UserEnableResult $value): UserApiDTO
    {
