...
class UserTaskReject implements TaskDescriptorInterface
{
    public function __construct(
        private readonly UserTaskReader $reader,
        private readonly UserRejectUsecase $usecase,
    ) {
    }
    ...
    public function process(TaskContext $context, mixed $item): mixed
    {
        ...
        return $this->usecase->reject($item->getUid());
    }
