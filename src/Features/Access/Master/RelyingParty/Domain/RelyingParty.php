...
use Civi\Lughauth\Features\Access\Master\RelyingParty\Domain\ValueObject\Accesor\RelyingPartyCodeAccesor;
use Civi\Lughauth\Features\Access\Master\RelyingParty\Domain\ValueObject\RelyingPartyApiKeyVO;
use Civi\Lughauth\Features\Access\Master\RelyingParty\Domain\ValueObject\Accesor\RelyingPartyApiKeyAccesor;
use Civi\Lughauth\Features\Access\Master\RelyingParty\Domain\ValueObject\RelyingPartyEnabledVO;
use Civi\Lughauth\Features\Access\Master\RelyingParty\Domain\ValueObject\Accesor\RelyingPartyEnabledAccesor;
use Civi\Lughauth\Features\Access\Master\RelyingParty\Domain\ValueObject\RelyingPartyScopesVO;
use Civi\Lughauth\Features\Access\Master\RelyingParty\Domain\ValueObject\Accesor\RelyingPartyScopesAccesor;
use Civi\Lughauth\Features\Access\Master\RelyingParty\Domain\ValueObject\RelyingPartySchemasVO;
use Civi\Lughauth\Features\Access\Master\RelyingParty\Domain\ValueObject\Accesor\RelyingPartySchemasAccesor;
use Civi\Lughauth\Features\Access\Master\RelyingParty\Domain\ValueObject\RelyingPartyPoliciesVO;
use Civi\Lughauth\Features\Access\Master\RelyingParty\Domain\ValueObject\Accesor\RelyingPartyPoliciesAccesor;
use Civi\Lughauth\Features\Access\Master\RelyingParty\Domain\ValueObject\RelyingPartyVersionVO;
use Civi\Lughauth\Features\Access\Master\RelyingParty\Domain\ValueObject\Accesor\RelyingPartyVersionAccesor;
use Civi\Lughauth\Features\Access\Master\RelyingParty\Domain\Formula\EnabledCalculator;
use Civi\Lughauth\Features\Access\Master\RelyingParty\Domain\Formula\ScopesCalculator;
use Civi\Lughauth\Features\Access\Master\RelyingParty\Domain\Formula\SchemasCalculator;
use Civi\Lughauth\Features\Access\Master\RelyingParty\Domain\Event\RelyingPartyCreateEvent;
use Civi\Lughauth\Features\Access\Master\RelyingParty\Domain\Event\RelyingPartyUpdateEvent;
use Civi\Lughauth\Features\Access\Master\RelyingParty\Domain\Event\RelyingPartyDeleteEvent;
use Civi\Lughauth\Features\Access\Master\RelyingParty\Domain\Event\RelyingPartyEnableEvent;
use Civi\Lughauth\Features\Access\Master\RelyingParty\Domain\Event\RelyingPartyDisableEvent;
...
class RelyingParty extends RelyingPartyRef
{
    ...
    public function enable(): RelyingParty
    {
        ...
        $value->recordedEvents[] = new RelyingPartyEnableEvent($value, original: $this);
        return $value;
    }
    public function disable(): RelyingParty
    {
        ...
        $value->recordedEvents[] = new RelyingPartyDisableEvent($value, original: $this);
        return $value;
    }
