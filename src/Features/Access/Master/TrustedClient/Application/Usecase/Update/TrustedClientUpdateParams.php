...
namespace Civi\Lughauth\Features\Access\Master\TrustedClient\Application\Usecase\Update;
...
class TrustedClientUpdateParams
{
    ...
    public function withDefaults(): TrustedClientUpdateParams
    {
        $this->withDefaultUid();
