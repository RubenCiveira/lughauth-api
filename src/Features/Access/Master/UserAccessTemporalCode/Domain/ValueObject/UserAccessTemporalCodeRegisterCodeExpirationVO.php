...
class UserAccessTemporalCodeRegisterCodeExpirationVO
{
    public static function empty(): UserAccessTemporalCodeRegisterCodeExpirationVO
    {
        return new UserAccessTemporalCodeRegisterCodeExpirationVO(null);
    }
    ...
    public static function tryFrom(mixed $value, ConstraintFailList $list): ?UserAccessTemporalCodeRegisterCodeExpirationVO
    {
        if (is_a($value, UserAccessTemporalCodeRegisterCodeExpirationVO::class)) {
            ...
            return new UserAccessTemporalCodeRegisterCodeExpirationVO($value);
        } elseif (is_string($value)) {
            if ($typed = self::readFromString($value)) {
                return self::tryFrom($typed, $list);
            } else {
                $list->add(new ConstraintFail('wrong_format', ['registerCodeExpiration'], [$value], ['\DateTimeImmutable']));
                return null;
            }
        } elseif (is_a($value, \DateTimeImmutable::class)) {
            return new UserAccessTemporalCodeRegisterCodeExpirationVO($value);
        } else {
            $list->add(new ConstraintFail('wrong_type', ['registerCodeExpiration'], [$value], ['\DateTimeImmutable']));
            return null;
        }
    }
    ...
    private function __construct(
        private readonly ?\DateTimeImmutable $registerCodeExpiration
    ) {
    }
