...
namespace Civi\Lughauth\Features\Access\Master\Tenant\Application\Usecase\Retrieve;
...
class TenantRetrieveResult
{
    ...
    public function withDefaults(): TenantRetrieveResult
    {
        $this->withDefaultUid();
