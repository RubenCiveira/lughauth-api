...
class TenantLoginProviderUpdateCheck
{
    public function __construct(public readonly TenantLoginProviderUpdateParams $input, public readonly TenantLoginProvider $current)
    {
    }
