...
namespace Civi\Lughauth\Features\Access\Master\ApiKeyClient\Infrastructure\Connector\Pdo;
...
class ApiKeyClientPdoConnector
{
    ...
    private function filter(?ApiKeyClientFilter $filter, ?ApiKeyClientCursor $sort, bool $count)
    {
        ...
        try {
            ...
            return [
              'query' => 'SELECT '.($count ? ' count("access_api_key_client".*) as count ' : '"access_api_key_client".*').' FROM "access_api_key_client"'
                . $join
