...
class SecurityAttributeUpdateCheck
{
    public function __construct(public readonly SecurityAttributeUpdateParams $input, public readonly SecurityAttribute $current)
    {
    }
