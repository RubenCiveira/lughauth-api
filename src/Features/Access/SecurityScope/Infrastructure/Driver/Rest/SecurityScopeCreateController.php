...
class SecurityScopeCreateController
{
    ...
    {
        $this->logDebug("Create Security scope");
        $span = $this->startSpan("Create Security scope");
        $this->sql->begin();
        try {
    ...
    private function readSecurityScope(ServerRequestInterface $request): SecurityScopeCreateParams
    {
    ...
    private function mapSecurityScope(SecurityScopeCreateResult $value): SecurityScopeApiDTO
    {
