...
trait SecurityScopeVersionAttributeHolder
{
    ...
    public function version(SecurityScopeVersionVO|int|null $version): static
    {
    ...
    {
        return is_a($this->version, SecurityScopeVersionVO::class) ? $this->version->value() : $this->version;
    }
    ...
    protected function withAssertedVersionRules(self $value, ConstraintFailList $errorsList): void
    {
        if ($value->versionAssigned = $this->versionAssigned) {
            $value->version = SecurityScopeVersionVO::tryFrom($this->version, $errorsList);
        }
    }
}
