...
class UserPersonalApiKeyTaskRevoke implements TaskDescriptorInterface
{
    public function __construct(
        private readonly UserPersonalApiKeyTaskReader $reader,
        private readonly UserPersonalApiKeyRevokeUsecase $usecase,
    ) {
    }
    ...
    {
        return $this->usecase->revoke($item->getUid());
    }
