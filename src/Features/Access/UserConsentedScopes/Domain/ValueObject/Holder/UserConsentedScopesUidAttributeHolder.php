...
trait UserConsentedScopesUidAttributeHolder
{
    ...
    public function getUidOrCurrent(UserConsentedScopesUidVO $uid): UserConsentedScopesUidVO
    {
        if ($this->uidAssigned) {
            ...
            return UserConsentedScopesUidVO::from($this->uid);
        } else {
            return $uid;
        }
    }
    ...
    {
        return $this->uid instanceof UserConsentedScopesUidVO ? $this->uid->value() : $this->uid;
    }
    ...
    protected function withAssertedUidRules(self $value, ConstraintFailList $errorsList): void
    {
        if ($value->uidAssigned = $this->uidAssigned) {
            $value->uid = UserConsentedScopesUidVO::tryFrom($this->uid, $errorsList);
        }
    }
}
