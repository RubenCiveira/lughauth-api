...
class RelyingPartyVisibilityService
{
    ...
    public function copyWithFixed(RelyingPartyAttributes $attributes, ?RelyingParty $original = null): RelyingPartyAttributes
    {
        ...
        try {
            ...
            $result = $this->dispatcher->dispatch(new RelyingPartyPresetValues($attributes, $original));
    ...
    public function fieldsToFix(?RelyingPartyRef $ref = null): array
    {
        ...
        try {
            $result = $this->dispatcher->dispatch(new RelyingPartyCollectNonEditableFields(RelyingParty::calculatedFields(), $ref));
    ...
    public function fieldsToHide(?RelyingPartyRef $ref = null): array
    {
        ...
        try {
            $result = $this->dispatcher->dispatch(new RelyingPartyCollectNonVisibleFields([], $ref));
    ...
    private function applyPreVisibilityFilter(RelyingPartyFilter $filter)
    {
        ...
        try {
            $result = $this->dispatcher->dispatch(new RelyingPartyRestrictFilterToVisibility($filter));
    ...
    private function evaluatePostVisibility(RelyingParty $value): bool
    {
        ...
        try {
            $result = $this->dispatcher->dispatch(new RelyingPartyVisibilityCheck(true, $value));
