...
trait TenantConfigVersionAttributeHolder
{
    ...
    {
        return $this->version instanceof TenantConfigVersionVO ? $this->version->value() : $this->version;
    }
    ...
    protected function withAssertedVersionRules(self $value, ConstraintFailList $errorsList): void
    {
        if ($value->versionAssigned = $this->versionAssigned) {
            $value->version = TenantConfigVersionVO::tryFrom($this->version, $errorsList);
        }
    }
}
