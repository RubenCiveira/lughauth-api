...
class UserRecoveryCodeExpirationVO
{
    public static function empty(): UserRecoveryCodeExpirationVO
    {
        return new UserRecoveryCodeExpirationVO(null);
    }
    public static function from(UserRecoveryCodeExpirationVO|\DateTimeImmutable|null $value): UserRecoveryCodeExpirationVO
    {
        if (is_a($value, UserRecoveryCodeExpirationVO::class)) {
    ...
    public static function tryFrom(mixed $value, ConstraintFailList $list): ?UserRecoveryCodeExpirationVO
    {
        if (is_a($value, UserRecoveryCodeExpirationVO::class)) {
            // If is a ValueObject, its already validated... nothing to append
            return $value;
        } elseif (!$value) {
            return new UserRecoveryCodeExpirationVO($value);
