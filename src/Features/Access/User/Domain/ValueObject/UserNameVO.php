...
class UserNameVO
{
    public static function from(UserNameVO|string $value): UserNameVO
    {
        return self::fromUnsafe($value);
    }
    public static function tryFrom(mixed $value, ConstraintFailList $list): ?UserNameVO
    {
        if ($value instanceof UserNameVO) {
            ...
            return $valid ? new UserNameVO($value) : null;
        } else {
    ...
    private static function fromUnsafe(mixed $value): UserNameVO
    {
        if ($value instanceof UserNameVO) {
            ...
            \assert($candidate instanceof UserNameVO);
            return $candidate;
        }
    }
    /**
    ...
    public function equals(?UserNameVO $other): bool
    {
