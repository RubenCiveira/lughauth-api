...
class UserUidVO
{
    public static function from(UserUidVO|string $value): UserUidVO
    {
        return self::fromUnsafe($value);
    }
    public static function tryFrom(mixed $value, ConstraintFailList $list): ?UserUidVO
    {
        if ($value instanceof UserUidVO) {
            ...
            return $valid ? new UserUidVO($value) : null;
        } else {
    ...
    private static function fromUnsafe(mixed $value): UserUidVO
    {
        if ($value instanceof UserUidVO) {
            ...
            \assert($candidate instanceof UserUidVO);
            return $candidate;
        }
    }
    /**
    ...
    public function equals(?UserUidVO $other): bool
    {
