...
use Civi\Lughauth\Features\Access\User\Infrastructure\Driver\Batch\UserTaskUnlock;
...
class UserUnlockController
{
  ...
  #[OA\Patch(path: "/api/access/users/{uid}/unlock", tags: ["User"], description: "Update the value",
    parameters: [
