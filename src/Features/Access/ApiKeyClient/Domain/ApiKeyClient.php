...
use Civi\Lughauth\Features\Access\ApiKeyClient\Domain\Event\ApiKeyClientDeleteEvent;
use Civi\Lughauth\Features\Access\ApiKeyClient\Domain\Event\ApiKeyClientEnableEvent;
use Civi\Lughauth\Features\Access\ApiKeyClient\Domain\Event\ApiKeyClientDisableEvent;
...
class ApiKeyClient extends ApiKeyClientRef
{
    ...
    public function enable(): ApiKeyClient
    {
        ...
        $value->recordedEvents[] = new ApiKeyClientEnableEvent(payload: $value, original: $this);
        return $value;
    }
    public function disable(): ApiKeyClient
    {
        ...
        $value->recordedEvents[] = new ApiKeyClientDisableEvent(payload: $value, original: $this);
        return $value;
    }
