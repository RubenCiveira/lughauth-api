...
trait ApiKeyClientVersionAttributeHolder
{
    ...
    {
        return $this->version instanceof ApiKeyClientVersionVO ? $this->version->value() : $this->version;
    }
    ...
    protected function withAssertedVersionRules(self $value, ConstraintFailList $errorsList): void
    {
        if ($value->versionAssigned = $this->versionAssigned) {
            $value->version = ApiKeyClientVersionVO::tryFrom($this->version, $errorsList);
        }
    }
}
