...
class ApiKeyClientUpdateUsecase
{
    ...
    public function allowUpdate(?ApiKeyClientRef $ref = null): Allow
    {
        ...
        try {
            $result = $this->dispatcher->dispatch(new ApiKeyClientUpdateAllowDecision(Allow::allowed('update', 'Allowed to update by default')));
    ...
    public function update(string $uid, ApiKeyClientUpdateParams $params): ApiKeyClientUpdateResult
    {
        ...
        try {
            ...
            if (!$allow->allowed) {
                throw new UnauthorizedException($allow->reason ?? 'Not allowed to update Api key client');
            }
