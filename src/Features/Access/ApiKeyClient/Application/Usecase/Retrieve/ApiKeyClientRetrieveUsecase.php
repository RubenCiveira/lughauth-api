...
class ApiKeyClientRetrieveUsecase
{
    ...
    public function allowRetrieve(?ApiKeyClientRef $ref = null): Allow
    {
        ...
        try {
            $result = $this->dispatcher->dispatch(new ApiKeyClientRetrieveAllowDecision(Allow::allowed('retrieve', 'Allowed to retrieve by default')));
    ...
    public function retrieve(string $uid): ApiKeyClientRetrieveResult
    {
        ...
        try {
            ...
            if (!$allow->allowed) {
                throw new UnauthorizedException($allow->reason ?? 'Not allowed to retrieve Api key client');
            }
