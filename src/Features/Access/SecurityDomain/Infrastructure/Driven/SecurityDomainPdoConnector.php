...
class SecurityDomainPdoConnector
{
    ...
    public function create(SecurityDomain $entity, ?Closure $verify = null): SecurityDomain
    {
        ...
        try {
            try {
                $this->db->execute('INSERT INTO "access_security_domain" ( "uid", "name", "level", "read_all", "write_all", "manage_all", "enabled", "version") VALUES ( :uid, :name, :level, :readAll, :writeAll, :manageAll, :enabled, :version)', [
    ...
    public function update(SecurityDomain $update): ?SecurityDomain
    {
        ...
        try {
            try {
                $result = $this->db->execute('UPDATE "access_security_domain" SET "name" = :name , "level" = :level , "read_all" = :readAll , "write_all" = :writeAll , "manage_all" = :manageAll , "enabled" = :enabled , "version" = :version WHERE "uid" = :uid and "version" = :_lock_version', [
