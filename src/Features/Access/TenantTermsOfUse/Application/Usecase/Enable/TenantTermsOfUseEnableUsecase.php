...
class TenantTermsOfUseEnableUsecase
{
    ...
    public function allowEnable(?TenantTermsOfUseRef $ref = null): Allow
    {
        ...
        try {
            $result = $this->dispacher->dispatch(new TenantTermsOfUseEnableAllowProposal(Allow::allowed('enable', 'Allowed to Tenant terms of use by default'), $ref));
            return $result->allow;
        } catch (Throwable $ex) {
    ...
    public function enable(string $uid): TenantTermsOfUseAttributes
    {
        ...
        try {
            ...
            return $this->dispacher->dispatch(new TenantTermsOfUseEnableOuputProposal($output))->attributes;
        } catch (Throwable $ex) {
            $span->recordException($ex);
            throw $ex;
        } finally {
