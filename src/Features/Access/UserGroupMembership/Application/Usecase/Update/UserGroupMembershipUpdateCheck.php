...
class UserGroupMembershipUpdateCheck
{
    public function __construct(public readonly UserGroupMembershipUpdateParams $input, public readonly UserGroupMembership $current)
    {
    }
