...
class TrustedClientEnableUsecase
{
    ...
    public function allowEnable(?TrustedClientRef $ref = null): Allow
    {
        ...
        try {
            $result = $this->dispacher->dispatch(new TrustedClientEnableAllowProposal(Allow::allowed('enable', 'Allowed to Trusted client by default'), $ref));
            return $result->allow;
        } catch (Throwable $ex) {
    ...
    public function enable(string $uid): TrustedClientAttributes
    {
        ...
        try {
            ...
            return $this->dispacher->dispatch(new TrustedClientEnableOuputProposal($output))->attributes;
        } catch (Throwable $ex) {
            $span->recordException($ex);
            throw $ex;
        } finally {
