...
class TrustedClientAllowedRedirectsUidVO
{
    public static function from(TrustedClientAllowedRedirectsUidVO|string $value): TrustedClientAllowedRedirectsUidVO
    {
    ...
    public static function tryFrom(mixed $value, ConstraintFailList $list): ?TrustedClientAllowedRedirectsUidVO
    {
        if ($value instanceof TrustedClientAllowedRedirectsUidVO) {
            ...
            return $valid ? new TrustedClientAllowedRedirectsUidVO($value) : null;
        } else {
    ...
    private static function fromUnsafe(mixed $value): TrustedClientAllowedRedirectsUidVO
    {
        if ($value instanceof TrustedClientAllowedRedirectsUidVO) {
            ...
            \assert($candidate instanceof TrustedClientAllowedRedirectsUidVO);
            return $candidate;
        }
    }
    /**
    ...
    public function equals(?TrustedClientAllowedRedirectsUidVO $other): bool
    {
