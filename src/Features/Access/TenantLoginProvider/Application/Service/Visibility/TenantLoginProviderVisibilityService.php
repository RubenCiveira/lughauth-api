...
class TenantLoginProviderVisibilityService
{
    ...
    public function copyWithFixed(TenantLoginProviderAttributes $attributes, ?TenantLoginProvider $original = null): TenantLoginProviderAttributes
    {
        ...
        try {
            ...
            $result = $this->dispatcher->dispatch(new TenantLoginProviderPresetValues($attributes, $original));
    ...
    public function fieldsToFix(?TenantLoginProviderRef $ref = null): array
    {
        ...
        try {
            $result = $this->dispatcher->dispatch(new TenantLoginProviderCollectNonEditableFields(TenantLoginProvider::calculatedFields(), $ref));
    ...
    public function fieldsToHide(?TenantLoginProviderRef $ref = null): array
    {
        ...
        try {
            $result = $this->dispatcher->dispatch(new TenantLoginProviderCollectNonVisibleFields([], $ref));
    ...
    private function applyPreVisibilityFilter(TenantLoginProviderFilter $filter): TenantLoginProviderFilter
    {
        ...
        try {
            $result = $this->dispatcher->dispatch(new TenantLoginProviderRestrictFilterToVisibility($filter));
    ...
    private function evaluatePostVisibility(TenantLoginProvider $value): bool
    {
        ...
        try {
            $result = $this->dispatcher->dispatch(new TenantLoginProviderVisibilityCheck(true, $value));
