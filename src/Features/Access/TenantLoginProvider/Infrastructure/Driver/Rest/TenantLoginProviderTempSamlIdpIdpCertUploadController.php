...
use Civi\Lughauth\Features\Access\TenantLoginProvider\Application\Usecase\UploadSamlIdpIdpCert\TenantLoginProviderUploadSamlIdpIdpCertUsecase;
use Civi\Lughauth\Shared\Observability\LoggerAwareTrait;
use Civi\Lughauth\Shared\Observability\TracerAwareTrait;

class TenantLoginProviderTempSamlIdpIdpCertUploadController
{
    ...
    public function __construct(
        ...
        private readonly TenantLoginProviderUploadSamlIdpIdpCertUsecase $uploadUsecase,
    ) {
    }
    public function uploadTemp(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        try {
            ...
            $response->getBody()->write($this->urlForTemporalSamlIdpIdpCert($request, $result));
