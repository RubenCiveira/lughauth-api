...
trait UserRoleAssignamentVersionAttributeHolder
{
    ...
    {
        return $this->version instanceof UserRoleAssignamentVersionVO ? $this->version->value() : $this->version;
    }
    ...
    protected function withAssertedVersionRules(self $value, ConstraintFailList $errorsList): void
    {
        if ($value->versionAssigned = $this->versionAssigned) {
            $value->version = UserRoleAssignamentVersionVO::tryFrom($this->version, $errorsList);
        }
    }
}
