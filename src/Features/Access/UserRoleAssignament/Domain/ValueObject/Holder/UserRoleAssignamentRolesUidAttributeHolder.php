...
trait UserRoleAssignamentRolesUidAttributeHolder
{
    ...
    public function getUidOrCurrent(UserRoleAssignamentRolesUidVO $uid): UserRoleAssignamentRolesUidVO
    {
        if ($this->uidAssigned) {
            ...
            return UserRoleAssignamentRolesUidVO::from($this->uid);
        } else {
            return $uid;
        }
    }
    ...
    {
        return $this->uid instanceof UserRoleAssignamentRolesUidVO ? $this->uid->value() : $this->uid;
    }
    ...
    protected function withAssertedUidRules(self $value, ConstraintFailList $errorsList): void
    {
        if ($value->uidAssigned = $this->uidAssigned) {
            $value->uid = UserRoleAssignamentRolesUidVO::tryFrom($this->uid, $errorsList);
        }
    }
}
