...
use Civi\Lughauth\Features\Access\Tenant\Infrastructure\Driver\Batch\TenantTaskEnable;
...
class TenantEnableController
{
  ...
  #[OA\Patch(path: "/api/access/tenants/{uid}/enable", tags: ["Tenant"], description: "Update the value",
    parameters: [
