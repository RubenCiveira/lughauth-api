...
class ConsentPurposeActivationDateVO
{
    ...
    public static function tryFrom(mixed $value, ConstraintFailList $list): ?ConsentPurposeActivationDateVO
    {
    ...
    private static function fromUnsafe(mixed $value): ConsentPurposeActivationDateVO
    {
        if ($value instanceof ConsentPurposeActivationDateVO) {
            ...
            \assert($candidate instanceof ConsentPurposeActivationDateVO);
            return $candidate;
        }
    }
    /**
    ...
    public function equals(?ConsentPurposeActivationDateVO $other): bool
    {
