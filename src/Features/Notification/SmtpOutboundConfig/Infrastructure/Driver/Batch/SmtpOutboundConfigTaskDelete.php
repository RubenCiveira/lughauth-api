...
class SmtpOutboundConfigTaskDelete implements TaskDescriptorInterface
{
    public function __construct(
        private readonly SmtpOutboundConfigTaskReader $reader,
        private readonly SmtpOutboundConfigDeleteUsecase $usecase,
    ) {
    }
