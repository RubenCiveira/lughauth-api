...
trait SmtpOutboundConfigUidAttributeHolder
{
    ...
    public function getUidOrDefault(SmtpOutboundConfigUidVO $uid): SmtpOutboundConfigUidVO
    {
        if ($this->uidAssigned) {
            ...
            return SmtpOutboundConfigUidVO::from($this->uid);
        } else {
            return $uid;
        }
    }
    ...
    {
        return $this->uid instanceof SmtpOutboundConfigUidVO ? $this->uid->value() : $this->uid;
    }
    ...
    protected function withAssertedUidRules(self $value, ConstraintFailList $errorsList): void
    {
        if ($value->uidAssigned = $this->uidAssigned) {
            $value->uid = SmtpOutboundConfigUidVO::tryFrom($this->uid, $errorsList);
        }
    }
}
