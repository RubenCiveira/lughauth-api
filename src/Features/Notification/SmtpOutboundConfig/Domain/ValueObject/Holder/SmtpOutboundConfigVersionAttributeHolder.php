...
trait SmtpOutboundConfigVersionAttributeHolder
{
    ...
    {
        return $this->version instanceof SmtpOutboundConfigVersionVO ? $this->version->value() : $this->version;
    }
    ...
    protected function withAssertedVersionRules(self $value, ConstraintFailList $errorsList): void
    {
        if ($value->versionAssigned = $this->versionAssigned) {
            $value->version = SmtpOutboundConfigVersionVO::tryFrom($this->version, $errorsList);
        }
    }
}
