...
class TemplateAssetRetrieveResult
{
  ...
  {
    if( $att ) {
  $this->readUidFrom($att);  $this->readTenantFrom($att);  $this->readCodeFrom($att);  $this->readTypeFrom($att);  $this->readContentFrom($att);  $this->readEnabledFrom($att);  $this->readVersionFrom($att);    }
  }
  public function toAttributes(): TemplateAssetAttributes
  {
    $att = new TemplateAssetAttributes();
  $this->writeUidTo($att);  $this->writeTenantTo($att);  $this->writeCodeTo($att);  $this->writeTypeTo($att);  $this->writeContentTo($att);  $this->writeEnabledTo($att);  $this->writeVersionTo($att);    return $att;  }
  ...
  public function withDefaults(): TemplateAssetRetrieveResult
  {
    $this->withDefaultUid();
