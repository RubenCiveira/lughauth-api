...
namespace Civi\Lughauth\Features\Document\TemplateAsset\Infrastructure\Connector\Pdo;
...
class TemplateAssetPdoConnector
{
  ...
  public function list(?TemplateAssetFilter $filter = null, ?TemplateAssetCursor $sort = null): array
  {
    $this->logDebug("List query for Template asset");
    $span = $this->startSpan("List query for Template asset");
    try {
  ...
  public function listForUpdate(?TemplateAssetFilter $filter = null, ?TemplateAssetCursor $sort = null): array
  {
    $this->logDebug("List query for update of Template asset");
    $span = $this->startSpan("List query for update of Template asset");
    try {
      $sqlFilter = $this->filter($filter, $sort, false);
  ...
  {
    $this->logDebug("Make query for entities for Template asset");
    $span = $this->startSpan("Make query for entities for Template asset");
    try {
      return $forUpdate ? $this->db->queryForUpdate($query, $params, fn(array $row): TemplateAsset => $this->mapper($row) ) : $this->db->query($query, $params, fn(array $row): TemplateAsset => $this->mapper($row) );
    } catch(Throwable $ex) {
      $span->recordException($ex);
      throw $ex;
    } finally {
  ...
  {
    $this->logDebug("Make raw query for Template asset");
    $span = $this->startSpan("Make raw query for Template asset");
    try {
  ...
  {
    $this->logDebug("Retrieve query for Template asset");
    $span = $this->startSpan("Retrieve query for Template asset");
    try {
      $sqlFilter = $this->filter($filter, null, false);
      return $this->db->findOne($sqlFilter['query'], $sqlFilter['params'], fn(array $row): TemplateAsset => $this->mapper($row) );
    } catch(Throwable $ex) {
      $span->recordException($ex);
      throw $ex;
    } finally {
  ...
  {
    $this->logDebug("Retrieve query for update of Template asset");
    $span = $this->startSpan("Retrieve query for update of Template asset");
    try {
      $sqlFilter = $this->filter($filter, null, false);
      return $this->db->findOneForUpdate($sqlFilter['query'], $sqlFilter['params'], fn(array $row): TemplateAsset => $this->mapper($row) );
    } catch(Throwable $ex) {
      $span->recordException($ex);
      throw $ex;
    } finally {
  ...
  public function create(TemplateAsset $entity, ?Closure $verify=null): TemplateAsset {
    $this->logDebug("Execute insert sql query for Template asset");
    ...
    try {
      ...
      if( $verify && !$verify($created)) {
        $this->db->execute('DELETE FROM "document_template_asset" where "uid" = :uid', [
          new SqlParam(name: 'uid', value: $entity->uid(), type: SqlParam::STR)
        ]);
  ...
  public function update(TemplateAsset $update): TemplateAsset {
    $this->logDebug("Execute update sql query for Template asset");
    ...
    try {
      try {
        ...
        if( !$result && $this->db->exists('select "uid" from "document_template_asset" where "uid" = :uid', ['uid' => $update->uid() ]) ) {
  ...
  public function delete(TemplateAssetRef $ref): bool
  {
    $this->logDebug("Execute delete sql query for Template asset");
    $span = $this->startSpan("Execute delete sql query for Template asset");
    try {
      try {
        return $this->db->execute('DELETE FROM "document_template_asset" where "uid" = :uid',[new SqlParam(name: 'uid', value: $ref->uid(), type:SqlParam::STR)]);
  ...
  {
    $this->logDebug("Execute exists sql query for Template asset");
    $span = $this->startSpan("Execute exists sql query for Template asset");
    try {
      $sqlFilter = $this->filter($filter, null, false);
  ...
  {
    $this->logDebug("Execute exists sql query for update of Template asset");
    $span = $this->startSpan("Execute update sql query for update of Template asset");
    try {
      $sqlFilter = $this->filter($filter, null, false);
  ...
  {
    $this->logDebug("Execute count sql query for Template asset");
    $span = $this->startSpan("Execute count sql query for Template asset");
    try {
  ...
  {
    $this->logDebug("Execute count sql query for update of Template asset");
    $span = $this->startSpan("Execute count sql query for update of Template asset");
    try {
      $sqlFilter = $this->filter($filter, null, true);
  ...
  private function checkDuplicates(TemplateAsset $entity, bool $creation): void
  {
  ...
  private function filter(?TemplateAssetFilter $filter,?TemplateAssetCursor $sort, bool $count): array
  {
    $this->logDebug("Build query filter of Template asset");
    $span = $this->startSpan("Build query filter of Template asset");
    try {
      $join = '';
      $query = '';
      $params = [];
      ...
      if( $filter ) {
        ...
        if ( null !== $filterTenant ) {
          $query .= ' and "document_template_asset"."tenant" = :tenant ';
        ...
        if ( null !== $filterTenants ) {
          $query .= ' and "document_template_asset"."tenant" in (:tenants)  ';
        ...
        if ( null !== $filterTenantTenantAccesible) {
          $join .= ' LEFT JOIN "access_tenant" as "tenantTenantAccesibleTenant" ON "tenantTenantAccesibleTenant"."uid" = "document_template_asset"."tenant"';
          ...
          foreach($sortOrder as $ord) {
            if ($ord === 'codeAsc') {
              ...
              if( null !== $sortSinceCode ) {
                $query .= " and " . ($equals ? substr($equals,4) . ' and ' : '') . ' "template-asset"."code" > :sinceCode';
                $equals .= ' and "template-asset"."code" = :sinceCode';
                $params[] = new SqlParam(name: 'sinceCode', value: $sortSinceCode, type: SqlParam::STR);
              }
              $order .= ', "document_template_asset"."code" asc';
            }
            if ($ord === 'codeDesc') {
              $sortSinceCode = $sort->sinceCode();
              if( null !== $sortSinceCode ) {
              ...
              $order .= ', "document_template_asset"."code" desc';
            }
          }
        } else {
          $sortSinceUid = $sort->sinceUid();
          if( null !== $sortSinceUid ) {
            $query .= ' and  "document_template_asset"."uid" < :sinceUid';
            $params[] = new SqlParam(name: 'sinceUid', value: $sortSinceUid, type: SqlParam::STR);
          }
          $order = ', "document_template_asset"."uid" desc';
        }
      }
      return [
        'query' => 'SELECT '.($count?' count("document_template_asset".*) as count ':'"document_template_asset".*').' FROM "document_template_asset"'
          . $join
  ...
  private function mapper(array $row): TemplateAsset
  {
    $this->logDebug("Mapping from sql to entity for Template asset");
    $span = $this->startSpan("Mapping from sql to entity for Template asset");
    try {
             $uid = $row['uid']??null;
            if( null === $uid ) {
            ...
            $content = TemplateAssetContentVO::fromStored($rawContent);
