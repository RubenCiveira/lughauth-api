...
class TemplateAssetEnableController
{
  ...
  #[OA\Patch(path: "/api/document/template-asset/{uid}/enable", tags: ["Template asset"], description: "Update the value",
    parameters: [
  ...
  {
    $this->logDebug("enable for Template asset");
    $span = $this->startSpan("enable for Template asset");
    $this->sql->begin();
    try {
      if (!isset($args['uid'])) {
  ...
  {
    $this->logDebug("enable all for query Template asset");
    $span = $this->startSpan("enable all for query Template asset");
    try {
      ...
      $res = $this->runner->run(TemplateAssetTaskEnable::class, ['filter' => $filter]);
  ...
  {
    $this->logDebug("Check enable all for query Template asset");
    $span = $this->startSpan("Check enable all for query Template asset");
    try {
      if (!isset($args['uid'])) {
        throw new NotFoundException('-');
      }
  ...
  private function mapTemplateAsset(ServerRequestInterface $request, TemplateAssetEnableResult $value): TemplateAssetApiDTO
  {
