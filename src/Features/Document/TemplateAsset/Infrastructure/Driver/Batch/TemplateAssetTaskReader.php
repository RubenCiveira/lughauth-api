...
namespace Civi\Lughauth\Features\Document\TemplateAsset\Infrastructure\Driver\Batch;
...
class TemplateAssetTaskReader implements TaskReaderInterface, TaskCounterInterface
{
    public function __construct(private readonly TemplateAssetListUsecase $usecase)
    {
    ...
    public function read(TaskContext $context): array
    {
        ...
        $result = $this->usecase->list($filter, $cursor ?? new TemplateAssetCursor(limit: 1));
