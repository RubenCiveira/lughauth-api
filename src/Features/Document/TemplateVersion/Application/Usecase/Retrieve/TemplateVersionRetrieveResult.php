...
class TemplateVersionRetrieveResult
{
  ...
  {
    if( $att ) {
  $this->readUidFrom($att);  $this->readTemplateFrom($att);  $this->readSubjectFrom($att);  $this->readContentHtmlFrom($att);  $this->readContentTextFrom($att);  $this->readVersionFrom($att);    }
  }
  public function toAttributes(): TemplateVersionAttributes
  {
    $att = new TemplateVersionAttributes();
  $this->writeUidTo($att);  $this->writeTemplateTo($att);  $this->writeSubjectTo($att);  $this->writeContentHtmlTo($att);  $this->writeContentTextTo($att);  $this->writeVersionTo($att);    return $att;  }
  ...
  public function withDefaults(): TemplateVersionRetrieveResult
  {
    $this->withDefaultUid();
