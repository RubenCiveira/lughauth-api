...
trait TemplateVersionVersionAttributeHolder
{
    ...
    {
        return $this->version instanceof TemplateVersionVersionVO ? $this->version->value() : $this->version;
    }
    ...
    protected function withAssertedVersionRules(self $value, ConstraintFailList $errorsList): void
    {
        if ($value->versionAssigned = $this->versionAssigned) {
            $value->version = TemplateVersionVersionVO::tryFrom($this->version, $errorsList);
        }
    }
}
