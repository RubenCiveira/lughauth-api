...
trait TemplateSnippetUidAttributeHolder
{
    ...
    public function getUidOrCurrent(TemplateSnippetUidVO $uid): TemplateSnippetUidVO
    {
        if ($this->uidAssigned) {
            ...
            return TemplateSnippetUidVO::from($this->uid);
        } else {
            return $uid;
        }
    }
    ...
    {
        return $this->uid instanceof TemplateSnippetUidVO ? $this->uid->value() : $this->uid;
    }
    ...
    protected function withAssertedUidRules(self $value, ConstraintFailList $errorsList): void
    {
        if ($value->uidAssigned = $this->uidAssigned) {
            $value->uid = TemplateSnippetUidVO::tryFrom($this->uid, $errorsList);
        }
    }
}
