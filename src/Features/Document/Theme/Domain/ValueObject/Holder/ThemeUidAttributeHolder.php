...
trait ThemeUidAttributeHolder
{
  ...
  if( $this->uidAssigned ) {
    ...
    return ThemeUidVO::from($this->uid);
  } else {
    return $uid;
  }
  }
  ...
  {
    return $this->uid instanceof ThemeUidVO ? $this->uid->value() : $this->uid;
  }
  ...
  protected function withAssertedUidRules(self $value, ConstraintFailList $errorsList): void  
  {
    if ($value->uidAssigned = $this->uidAssigned) {
      $value->uid = ThemeUidVO::tryFrom($this->uid, $errorsList);
    }
  }
}
