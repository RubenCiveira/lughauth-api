...
final class ClientRegistrationAdapter implements ClientRegistrationGateway
{
    ...
    public function findByClientIdAndToken(string $clientId, string $registrationAccessToken): ?ClientRegistrationData
    {
        ...
        return $this->mapToClientRegistrationData($client);
    }
    ...
    public function update(string $clientId, string $registrationAccessToken, ClientRegistrationRequest $request): ?ClientRegistrationData
    {
        ...
        return $this->mapToClientRegistrationData($updated);
    }
    ...
    private function mapToClientRegistrationData(TrustedClient $client): ClientRegistrationData
    {
        $redirectUris = [];
